	        ...
	        public function searchSingleDataUpload()
		{
			...
			$checkNull='';
					if(empty($data1)){
						...
						$checkNull .='<p><span>CURRENTLY SELECTED : </span> NO GUEST LIST SELECTED</p>';
					}
			$output = '';
			if($data > 0)
			{
				...
				if(!empty($data->last_edited_username)){ $last_edited_username= $data->last_edited_username; }else{ $last_edited_username= "NIL";  }
					...
					$output .= '
						...
						<tr>
						<td colspan="2" class="top-fp"><p><span>CURRENTLY SELECTED :</span><span id="multipleGUESTSelect" style="color:black;" > '.$data->file_name.'</span></p></td>
					   </tr>
						
						
						<tr id="currentlyViewing" style="">
						<td  colspan="2" class="currentlyviewingclass"><p><span>CURRENTLY VIEWING :</span><span class="pname"> '.$data->file_name.'</span></p></td>
					    </tr>
