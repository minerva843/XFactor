...
$config['tables']['xf_mst_users']           = 'xf_mst_users';
$config['tables']['groups']          = 'xf_mst_group';
 ...
 */
$config['site_title']                 = "XPLATFORM";       // Site Title, example.com
$config['admin_email']                = "admin@xmanage.network"; // Admin Email, admin@example.com
$config['default_group']              = 'XPLATFORM';           // Default group, use name
...
$config['user_expire']                = 14400;               // How long to remember the user (seconds). Set to zero for no expiration - see sess_expiration in CodeIgniter Session Config for session expiration
...
'mailtype' => 'html',
'protocol' => 'smtp',
'smtp_host' => 'mail.xmanage.network',
'smtp_user' => 'admin@xmanage.network', // actual values different
'smtp_pass' => 'NoDelays2020',
'smtp_port' => 587,
'charset' => 'utf-8',
'MIME-Version' => '1.0',
'newline' => "\r\n"
...
$config['email_success'] = 'success_walk_in.tpl.php';
$config['email_success_guest'] = 'success_guest.tpl.php';
$config['email_mass_upload'] = 'mass_upload.tpl.php';
$config['email_mass_upload_delete'] = 'mass_upload_delete.tpl.php';

$config['email_success_guest_no_reg_exist'] = 'success_guest_no_reg_exist.tpl.php';
$config['email_success_guest_no_reg_new'] = 'success_guest_no_reg_new.tpl.php';
$config['email_success_guest_reg_exist'] = 'success_guest_reg_exist.tpl.php';
$config['email_success_guest_reg_new'] = 'success_guest_reg_new.tpl.php';
$config['emailer_email_success'] = 'emailer_email_success.tpl.php'; 
$config['emailer_bcc_email'] = 'emailer_bcc_email.tpl.php'; 
...
$config['message_start_delimiter'] = '<p style="color:#00b050;">'; 	// Message start delimiter
