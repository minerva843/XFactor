...
.tooltip:hover .tooltip__content {
  ...
  visibility: visible;
		...
		<div class="start-explor"> <h2 class="project_name"><?php if(!empty($project_name)){echo $project_name;
						if($topprojectdata->header_lets_explore_title){ echo '. '.$topprojectdata->header_lets_explore_title; }else{ echo '. START EXPLORING. HAVE FUN! =)'; }
						 }else{ echo 'CLICK “PLACES” ON BOTTOM RIGHT, THEN SELECT A PLACE TO GO.'; }?> </h2></div>
		...
		<div class="row">
				 ...
				 <div class="col-md-6">   
                  <div class="looka-took">
									...
									<span class="common-space"> <?php if(empty($project)){ echo '<p style="color:red">TO START, SELECT A PLACE TO GO TO FIRST.</p>'; }else{ echo $GetHistory->zone_text; }?> </span>
				...
				<h4 class="modal-title">XCONNECT</h4>
									...
									<div class="modal-body">
                                        <h3 style="text-align:center; padding-top: 0;">This program is taking place in another zone.</h3>
										<h3 style="text-align:center; padding-top: 0;">Do you want to proceed there?</h3>
		...
		<?php if(empty($project)){ //echo '<p class="pl-kkc">FOR YOUR CONTROLS TO WORK, A PLACE MUST BE SELECTED FIRST.</p>'; 
		}?>
		<?php if(!empty($No_registerUser)){ echo $No_registerUser; ?>
					...
					<!--div class="blok-program"></div-->
						...
						<div class="avtar-left to-start-select" id="container11" style="display:none;">
  ...
  <div class="modal-dialog">
    <div class="modal-content">
	  ...
	  <div class="tooltips-inner">
		...
		<p class="program-desc"><?php echo substr($myprogram->program_details,0,180)?></p>
	    </div>  
       <div class="quick-intro"> 
		...
		<div class="chat-close"><a href="#" class="rem_close" data-dismiss="modal">CLOSE</a></div>
						...
						<?php //}else{ ?>
	<div id="item2" style="width: 20px; height: 20px; border-radius: 50%; touch-action: none; user-select: none; position: absolute;z-index: 111;display:none;">
<!--<img src="<?=base_url();?>assets/images/place-icon.png" class="place-drag-icon">  --> 
	</div>
...
<div class="container" >
	...
	<?php }?>
						...
						//print_r($top);print_r($left);die;
						 ?>
						<?php if(!empty($img)){?>
						
						
							
							<div id="item1" class="red_dots" style=" touch-action: none; user-select: none; position: absolute;top: <?php echo $top;?>px;left: <?=$left?>px;z-index: 11;"></div>
...
if($mydata){
			foreach($mydata as $val){
				$query2=$this->db->get_where('xf_guest_users',array('id'=>$val));
					$res=$query2->row();
				if($res){
				echo $res->guest_type .', '.$res->first_name.' '.$res->last_name.'</br>'.$res->designation.', '.$res->company;
				echo '<br>';
				echo '<br>';
				}
			} 
...
<div class="program_new_five ">
<p> <?php //echo substr($data->program_details,0,193)?></p>
<p> 
...
?>    			
				<li>
<a class="track_menu" data-track="PLACES" href="<?=base_url();?>places/redirectanother/<?php echo $project;?><?php if(!empty($floor)){ echo '/'.$floor; }?>" ><img src="<?=base_url();?>assets/images/chat/places.png" class="img-fluid"><span>PLACES</span></a>
</li>
<li>
<a data-track="AVATAR" class="track_menu" href="<?=base_url();?>avatar/redirectanother/<?php echo $project;?><?php if(!empty($floor)){ echo '/'.$floor; }?>" ><img src="<?=base_url();?>assets/images/chat/avtar.png" alt=""><span>MY AVATAR</span></a>
</li>
<li>
<a data-track="CHAT" class=" track_menu" href="<?=base_url();?>chat_box/redirectanother/<?php echo $project;?><?php if(!empty($floor)){ echo '/'.$floor; }?>" ><img src="<?=base_url();?>assets/images/chat/chat.png" alt=""><span>CHAT</span></a>
</li>
<li>
<a data-track="CONTENT" class="track_menu" href="<?=base_url();?>content_page/redirectanother/<?php echo $project;?><?php if(!empty($floor)){ echo '/'.$floor; }?>" ><img src="<?=base_url();?>assets/images/chat/watch.png" alt=""><span>CONTENT</span></a>
</li>
<li>
<a data-track="WORKSHOP" class="track_menu" href="<?=base_url();?>workshop/redirectanother/<?php echo $project;?><?php echo '/'.$floor; ?>" ><img src="<?=base_url();?>assets/images/chat/shops.png" alt=""><span>WORKSHOPS</span></a>
</li>   
<li>
<a data-track="POSTS" class=" track_menu" href="<?=base_url();?>post_front/redirectanother/<?php echo $project;?><?php if(!empty($floor)){ echo '/'.$floor; }?>" ><img src="<?=base_url();?>assets/images/chat/visit.png" alt=""><span>POSTS </span></a>  
</li>
<li class="active">
<a data-track="PROGRAM" class="track_menu active" href="<?=base_url();?>program_page/index/<?php echo $project;?><?php if(!empty($floor)){ echo '/'.$floor; }?>" class="active"><img src="<?=base_url();?>assets/images/chat/program.png" alt=""><span>PROGRAM</span></a>
</li>      
<script>
