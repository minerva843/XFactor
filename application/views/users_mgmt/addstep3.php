 ...
 <form method="POST"  class="register-form_1" id="register-form2899989" enctype="multipart/form-data">
        <div class="top-header">
            <div class="row">
                ...
                <div class="col-md-3">
                    <div class="top-close"><input type="button" value="CLOSE" class="close-btn" name="submit" id="close-btnstep3guest"></div>
                </div>
            </div>   
        </div>	   
...
$(document).ready(function(){
      ...
      $("body").on('click','#guestlistupload3user',function(){
      ...
      $.fancybox.open({
        ...
        clickOutside: false
        		    ...
        		    $("body").on('click', '#usermanageassignmain67', function() {
                                            $.fancybox.getInstance('close');
                                            $.fancybox.open({
                                                maxWidth: 800,
                                                fitToView: true,
      ...
      $.fancybox.open({
        ...
        autoSize  : true,
        type        : "ajax",
        src         : '<?=base_url();?>UserManage/addstep2/<?php echo $id; ?>',
        ajax: { 
...
$('body').on('click', '#close-btnstep3guest', function () {
            $.fancybox.close(); 
...
var url="<?php echo base_url();?>UserManage/addstep3Post"; 
...
$.ajax({  
	...
	if (data) {             
      ...
      <?php if($no_reg){ ?>
        ...
        autoSize  : true,
        type        : "ajax",
        src         : '<?=base_url();?>UserManage/addUserSuccess',
        ajax: { 
