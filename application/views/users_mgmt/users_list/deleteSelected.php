                    ...
                    <div class="tab right-tabs">
                        ...
                        <div class="table-content">
                            <ul class="nav nav-tabs ">
                                ...
                                <li id="mainmenu0009999" class=""><a data-toggle="tab" href="#menu1" >MAIN MENU</a></li>
                                <li id=""  class="active"><a data-toggle="tab"  href="#menu2">USER LISTS</a></li>
                                <li class="" id="assi45540909"><a data-toggle="tab" href="#menu3">ASSIGN USERS</a></li>

                            </ul>
                            <div class="table_info floor-step">

                                <p style="color:#00b050!important;">CURRENTLY SELECTED : <span style="color:black;font-size: 14px;"><?php if ($selected && !$single) {
                                                                                                                                        echo "MULTIPLE USER LISTS";
                            ...
                            <div class="form-submit">
                                <a class="action-btn" id="groupchatback9090000">Back</a>
                                <input type="button" value="NEXT" class="action-btn" name="submit" id="btn555delsucessgroupaction999">
                            </div>
                        </div>
                    </div>
                </div>
...
<script>
    function myFunction() {
      ...
      $("body").on('click', '#assi45540909', function() {
       ...
       $("body").on('click', '#mainmenu0009999', function() {
        $.fancybox.getInstance('close');
        $.fancybox.open({
        maxWidth  : 800,
        fitToView : true,
     ...
     $("body").on('click','#btn555delsucessgroupaction999',function(){
           $.fancybox.getInstance('close');
       ...
       //alert(strids);
        ...
        autoSize  : true,
        type        : "ajax",
        src         : "<?php echo base_url(); ?>UserManage/deleteUsersMainByFileUploadSuccess",
        ajax: { 
    ...
    $("body").on('click', '#groupchatback9090000', function() {
