            ...
            <div class="row">
                <div class="col-md-9">
                    <h2>USERS (DELETE<?php if ($selected) {
                                                ...
                                                echo " ALL";
                                            } ?>) <span class="sucess">SUCCESSFUL </span> </h2>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-9">
                                        ...
                                        <div class="form-group row">
                                            <label for="colFormLabel" class="col-sm-4 col-form-label">XMANGE ID</label>
                                            <div class="col-sm-8">
                                        ...
                                        <div class="form-group row">
                                            <label for="colFormLabel" class="col-sm-4 col-form-label">CREATED XPLATFORM ID</label>
                                            <div class="col-sm-8">
                    ...
                    <div class="tab right-tabs">
                        ...
                        <div class="table-content">
                            ...
                            <div class="form-submit">
                                <a class="action-btn" id="printbbutton"  onclick="printJS({printable:'printJS-form', type:'html',targetStyles: ['*']})" >PRINT</a>
                                <input type="button" value="DONE" class="action-btn" name="submit" id="btn555listaction33">
                            </div>
                        </div>
                    </div>
                </div>
...
$("#printbutton").click(function () {
    ...
    function myFunction() {
     ...
     $("body").on('click','#btn555listaction33',function(){
           $.fancybox.getInstance('close');
    ...
    $("body").on('click', '#groupchatback909089', function() {
