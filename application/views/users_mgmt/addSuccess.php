<div class="main-section fancybox-content" id="add-floor" style=""> 
    <div class="container">
        ...
        <div class="top-header">
            <div class="row">
                <div class="col-md-9">  
                    <h2>USER  (<?php echo $action; ?>) <span class="sucess">SUCCESSFUL </span></h2>
                       <p> <b><?php echo date('Ymd Gi'); ?>h.</b> THIS USER HAS BEEN <?php echo $action; ?>ED.</p>
                </div>
            ...
            <div class="row">
	            ...
	            <div class="leftbox-top">
		            ...
		            <div class="row">
						...
						<div class="col-sm-8">
						<div class="zone-label"><?php echo $guest->ip_address;  ?></div>
						</div>
						</div>
						...
						<br><br>
                              ...
                              $allgroups = $this->Usermanage_model->getGroupsMappedOnUsersmain($guest->id); 
  ...
  <script>
     ...
     $("body").on('click', '#openusermanagelist888', function() {
      ...
      $.fancybox.open({
        ...
        clickOutside: false
                                    ...
                                    $("body").on('click', '#usermanageassignmain5', function() {
                                            $.fancybox.getInstance('close');
                                            $.fancybox.open({
                                                maxWidth: 800,
                                                fitToView: true,
