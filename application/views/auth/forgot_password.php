...
#forget-pass .signup-form .form-submit {
	...
	<!--div class="header-xconnect">
		...
		<li><a href="#!"> <span>SIGN UP</span>  <img src="../assets/images/sign-edit.png"></a></li>
...
& LIVE STREAMS</a></li>
     ...
     <div class="container-fluid">
		...
		<div class="col-md-12">    
                ...
                <div class="signup-form reset_pass">   
                    <form method="POST" action="<?=base_url()?>auth/forgot_password" class="register-form form-inline" id="login-form">
...
?>
						...
						<div class="form-group row">
                                <label for="email" class="col-sm-4 col-form-label" style="padding-left: 0px;">USER ID</label>
                                <div class="col-sm-6">
							...
							<input type="submit" value="OK" class="submit" name="submit" id="submit-forget" />
							  ...
							  <!--  <div class="form-group">
                                <div class="col-md-3"><label for="email" class="user">USERID</label></div>
                                <div class="col-md-9"><input type="text" id="identity" name="identity" placeholder="ENTER USER ID" /></div>
                            </div>
						...
						<a href="<?=base_url()?>auth/register" class="switcher-text2">REGISTER AN ACCOUNT</a>
						</div>
						</div>
                    </form>
