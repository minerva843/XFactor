	...
	<body>
		<table>
			<tbody>
				...
				<td colspan="2" style="font-size:11px; padding-bottom:10px; width:100%;">
				 Hi <span style="font-size:11px;"><?=$username;?></span>,
				</td>    
				</tr>    
			...
			<tbody>
				<tr>
					<td style=" font-size:11px ; padding-bottom:10px; width:100%;">
						<div >
							<p>NOTE: This email was generated if you have registered successfully via registration form, or you have 
								<br> been added to guest list by <span style="font-weight:bold ;"><?php echo $project_name; ?> </span>. To be excluded, simply inform  <span style="font-weight:bold ;"><?php echo $project_name; ?> </span>
								<br> through chat feature on XCONNECT.
							</p>
						</div>
					</td>
				</tr> 	
			...
			<tbody>
				<tr>
					<td style=" font-size:14px ; font-weight:bold ; padding-bottom:10px; width:100%;">
						XPLATFORM - USER ACCOUNT REGISTRATION SUCCESSFUL.
					</td>
				</tr> 	
				<tr></tr>
			 </tbody>
		...
		<table>
			<tbody> 				
				...
				<tr>
					...
					<td style="font-size:11px ; font-family: calibri!important; padding-bottom:10px;">: <a href="<?=$website;?>"><?=$website;?></a></td>				       
				</tr>  
				...
				<tr>
					...
					<td style="font-size:11px ; vertical-align: top; font-family: calibri!important; padding-bottom:10px;"> <p style="position: absolute;">: </p> <?php echo $qrcode;?>  </td>    
				</tr>
				<tr></tr>			   
			</tbody>
		 </table>
		   ...
		   <tbody>
			   <?php if(!empty($salutation)){?>
				<tr>
				   ...
				   <td style="font-size:11px; font-family: calibri!important; padding-bottom:10px; text-transform:uppercase; font-weight:normal;">: <?=$salutation?></td>
				</tr>
				<?php } if(!empty($gender)){?>
		...
		<table>    
			<tbody>
				...
				<tr>   
					...
					<td style="font-size:11px; font-family: calibri!important; padding-bottom:10px;">: A list of all places you can explore on XCONNECT. </td>
				</tr>
		...
		<P style="font-size:11px;width:100%;">Start exploring today! Have fun! =)</P>
					     
		  <p style="font-size:14px ; padding-bottom:0px; margin-bottom:0px; font-weight:bold ;">WARMEST REGARDS</p>
		  <p style="font-size:11px; padding-bottom:10px;"><span style="font-size:11px;">THE XPLATFORM TEAM</span></p>
							  
		   <p style="font-size:11px; text-transform: initial;">This is a computer generated email. Please do not reply.</p>    
