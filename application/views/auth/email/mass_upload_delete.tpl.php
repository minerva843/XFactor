...
<link href="https://fonts.googleapis.com/css2?family=Roboto:ital,wght@0,100;0,300;0,400;0,500;0,700;1,100;1,300;1,400;1,500&display=swap" rel="stylesheet">    
 ...
 body{
	...
	<body>            
		<table>
			<tbody>
				<tr style="font-size:11px;" >Hi <span style="font-size:11px;"><?=$username;?></span>,</tr> 
				<tr></tr>
				
				<tr></tr>
				<tr style="font-size:11px; width:100% ;">
					<td colspan="2" style="font-size:11px; width:100%;">
							<span style="font-size:14px; "> Delete</span>, mass data entry is completed. </span>
					</td>   	
				</tr>    
				<tr></tr>			
				
				<td colspan="2" style="font-size:11px; width:100%;">
					 <span style="font-size:14px!important; font-weight:bold!important;"> MASS DATA ENTRY – ENTRIES DELETED FROM DATABASE</span> 
					</td> 
