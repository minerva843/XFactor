...
<link href="https://fonts.googleapis.com/css2?family=Roboto:ital,wght@0,100;0,300;0,400;0,500;0,700;1,100;1,300;1,400;1,500&display=swap" rel="stylesheet">    
 ...
 body{
	...
	<body>
		<table>
			<tbody>
				<tr style="font-size:11px; padding-bottom:20px; width:100%;"> <td colspan="2">Hi <span style="font-size:11px;"><?=$username;?></span>, </td></tr> 
				<tr><td colspan="2"> &nbsp;</td></tr>  
				<tr style="font-size:11px; padding-bottom:20px; width:100%;"> <td colspan="2">Thank you for registering.</td></tr>   
				<tr><td colspan="2"> &nbsp;</td></tr>
							
				<tr>   
					<td style="font-weight:bold ; font-size:11px ; padding-bottom:10px; width:22%;">QUICK LINK TO PLACE</td>
					<td style="font-size:11px ; padding-bottom:20px;">: <a href="<?=$website.'places/index/'.$project_id;?>"><?=$website.'places/index/'.$project_id;?></a></td>				       
				</tr> 
				<tr><td colspan="2"> &nbsp;</td></tr>		
			</tbody>
		</table>  
