...
<link href="https://fonts.googleapis.com/css2?family=Roboto:ital,wght@0,100;0,300;0,400;0,500;0,700;1,100;1,300;1,400;1,500&display=swap" rel="stylesheet">    
   <style>
	...
	<body>  
		<table>
			<tbody>     
				<tr style="font-size:11px; padding-bottom:20px; width:100%;"> 
				<td colspan="2">Hi <span style="font-size:11px;"><?=$username;?></span>, </td></tr> 
				<tr><td colspan="2"> &nbsp;</td></tr>
				<tr style="font-size:11px; padding-bottom:20px; width:100%;"> 
				<td colspan="2">Thank you for registering. </td></tr>     
				<tr><td>&nbsp;</td></tr>    
				<tr style="font-size:11px; width:100%; padding-bottom:20px;">
		...
		<table style="width:100%;">
			<tbody>
				<tr>
					<td style=" font-size:11px ; font-size:14px ; font-weight:bold ; padding-bottom:10px; width:100%;">
