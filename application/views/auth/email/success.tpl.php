...
table.userrr td{font-size:16px !important;}
b,td,h4,h2,p,h6{
...
<link rel="stylesheet" type="text/css" href="<?=base_url();?>assets/css/style.css">
				...
				<td colspan="2" style="font-weight:bold !important; padding-bottom:10px; font-size:14px!important; padding-bottom:10px; width:100%!important;">YOUR XPLATFORM ACCOUNT LOG IN CREDENTIALS</td>						   		
						...
						<tr>
						   <td style="font-weight:bold !important; font-size:11px !important; padding-bottom:10px; width:22%;">PLACE URL</td>
						   <td style="font-size:11px !important; padding-bottom:10px;">: <a href="<?=$website.'/places/index/'.$project_id;?>"><?=$website.'places/index/'.$project_id;?></a></td>				       
						</tr>        
						
					   	<tr>
						   <td style="font-weight:bold !important; font-size:11px !important; padding-bottom:10px; width:22%;">USER NAME </td>
						   <td style="font-size:11px !important; padding-bottom:10px;">: <?=$email;?></td>
				       </tr>   
						<!--tr>
						   <td style="font-weight:bold !important; font-size:12px !important; padding-bottom:10px; width:22%;">PASSWORD</td>
						   <td style="font-size:12px !important; padding-bottom:10px;">: <?=$password;?></td>
				       </tr -->     
					   	<tr>
...
<?php }?>
					...
					<!--    <p>with your xmange account you will be enjoy access to the fllowing features:</p>
					   ...
					   <?php if(!empty($salutation)){?>
					   	<tr>
						   <td style="font-size:11px; padding-bottom:10px; font-weight:600; width:22%;">SALUTATION</td>
						   <td style="font-size:11px; padding-bottom:10px; text-transform:uppercase; font-weight:normal;">: <?=$salutation?></td>
				       </tr>
					   <?php } if(!empty($gender)){?>
					   	<tr>
						   <td style="font-size:11px; padding-bottom:10px; font-weight:600; width:22%;;">GENDER</td>
						   <td style="font-size:11px; padding-bottom:10px; text-transform:uppercase; font-weight:normal;">: <?=$gender?></td> 
				       </tr>
					   <?php } if(!empty($first_name)){?>
					   	<tr>
						   <td style="font-size:11px; padding-bottom:10px; font-weight:600; text-transform:uppercase; width:22%;">FIRST NAME</td>
					   ...
					   <?php } if(!empty($last_name)){?>
					     	<tr>
						   <td style="font-size:11px !important; padding-bottom:10px; font-weight:600; width:18%;">LAST NAME</td>
					   ...
					   <tr>
						   <td style="font-size:11px; padding-bottom:10px; font-weight:600; text-transform:uppercase; width:25%;">MOBILE</td>
					   ...
					   <tr>
						   <td style="font-size:11px; padding-bottom:10px; font-weight:600; width:25%;">BIRTHDAY</td>
					   ...
					   <?php }?>
					    ...
					    <h2 style="font-size:20px; font-weight:600;">QUICK TIPS</h2>
						<?php if(!empty($project)){?>
...
<?php }?>    
					   ...
					   <tbody>
					    <p style="font-size:11px; font-weight:600!important; margin-bottom:2px;"><b>XCONNECT</b></p>
					   	<!-- tr>
						   <td style="font-size:12px; font-weight:bold !important; padding-bottom:10px; !important; width:22%;"><b>WHAT'NEW</b></td>
						   <td style="font-size:12px;">: List of all places you can explore on <b style="font-size:12px; font-weight:600;">XPLATFORM</b></td>
				       </tr>
					   	<tr>
						   <td style=" font-size:12px; font-weight:bold !important; padding-bottom:10px; width:22%;"><b>LET'S EXPLORE</b></td>
						   <td style="font-size:12px;">: Interactive user interface. This is the key highlight of <b style="font-size:12px; font-weight:600;">XCONNECT</b></td>
				       </tr-->        
					   
					   <tr>   
						   <td class="shop" style="font-weight:bold !important; font-size:11px; padding-bottom:10px; width:22%;"><b>ALL PLACES</b></td>
						   <td class="spac1" style="font-size:11px;">: List of all places you can explore on <b style="font-size:12px; font-weight:600;">XPLATFORM</b></td>
				       </tr>
					   
					   <tr>
					<td class="shop" style="font-weight:bold !important; font-size:11px; padding-bottom:10px; width:22%;"><b>LET'S EXPLORE</b></td>
						   <td class="spac1" style="font-size:11px;">: Interactive user interface. This is the key highlight of <b style="font-size:12px; font-weight:600;">XCONNECT</b></td>
				       </tr>
...
<?php }?>
					...
					<p style="font-size:14px !important; padding-bottom:0px!important; margin-bottom:0px!important; font-weight:bold !important;">WARMEST REGARDS,</p>
					  <p class="team-rgds" style="font-size:14px; padding-bottom:10px;">THE <span style="font-size:16px; font-weight:600;">XPLATFORM</span> TEAM</p>
