...
<link href="https://fonts.googleapis.com/css2?family=Roboto:ital,wght@0,100;0,300;0,400;0,500;0,700;1,100;1,300;1,400;1,500&display=swap" rel="stylesheet">    
 body{
	...
	<body>
			...
			<tbody>
				...
				<tr style="font-size:11px; width:100% ;">
					<td colspan="2" style="font-size:11px; width:100%;">
							<span style="font-size:14px; "> XPLATFORM – USER ACCOUNT REGISTRATION SUCCESSFUL. </span>
					</td>   	
				</tr> 
		...
		<tr></tr>			   
		<p style="font-size:14px; padding-bottom:6px; width:100%;">YOUR REGISTRATION DETAILS </p>  
		...
		<p style="font-family:calibri ; font-size:14px; font-weight:bold;">HIGHLIGHTS</p>
							
		<p style="font-family:calibri ; font-size:11px;width:100%">Your XPLATFORM account allows you to enjoy access to: </p>  
