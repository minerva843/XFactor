                    ...
                    <div class="master-floorplan">
						...
						$(".deletClass").removeClass('hide');
                                         ...
                                         $(".SER").on("keyup", function() {
                                           ...
                                           // $('.form-submit').hide();
                                            $('.deletClas:checked').removeAttr('checked');
                                            $('.configClas:checked').removeAttr('checked');
                                            $(".configClass").removeClass('hide');
                                            $(".deletClass").removeClass('hide');
                                        ...
                                        $("body").on('click', '#submitbtndelgroupassign', function() {
                                                ...
                                                if (ids.length) {
                                                    ...
                                                    $.fancybox.open({
                                                        ...
                                                        autoSize: true,
                                                        type: "ajax",
                                                        src: "<?php echo base_url(); ?>UserManage/updateTabsuserGroupassign_new",
                                                        ajax: {
                                                            settings: {
                    ...
                    <div class="tab right-tabs">
                        ...
                        <div class="table-content">
                            <ul class="nav nav-tabs ">
                                <li id="openindividualchats989897787" class=""><a data-toggle="tab" href="#">MAIN MENU</a></li>
                                <li class="" id="allgrouppermission474774"><a   data-toggle="tab"  href="#home">USER LIST</a></li>
