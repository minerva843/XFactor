...
<div class="main-section">
    <div class="container">
        ...
        <div class="top-header">
            <div class="row">
                <div class="col-md-9">
                    <h2>CONFIG PAGE ACCESS<span id="" style="font-size:18px;"></span></h2>
                </div>
						...
						$(".deletClass").removeClass('hide');
                                        ...
                                        $("body").on('click', '#submitbtndelgroupassignremove', function() {
                                               ...
                                               var configids = [];
												...
												$('.deletClas:unchecked').each(function(i, e) {
                                                    ...
                                                    $.fancybox.open({
                                                        ...
                                                        autoSize: true,
                                                        type: "ajax",
                                                        src: "<?php echo base_url(); ?>UserManage/updateuserGroupassignConfig",
                                                        ajax: {
                                                            settings: {
                                        ...
                                        function load_data(guest = '', shortby = '', Allsearch = '') {
                                            ...
                                            $.ajax({
                                                url: "<?= base_url(); ?>UserManage/allUsersListConfig",
                                                method: "POST",
                                                data: {
                                                    selectData: guest,
                    ...
                    <div class="tab right-tabs">
                        ...
                        <div class="table-content">
                            <ul class="nav nav-tabs ">
                                ...
                                <li id="openindividualchats9999099" class=""><a   data-toggle="tab"  href="#home">PERMISSIONS</a></li>
