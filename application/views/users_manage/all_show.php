                        ...
                        <div class="floor-sec">
                            <div class="tab-listing">
                                <div class="row master-filters">
                                    <div class="col-md-2">
                                        <select class="dropdown" name="workshop" id="selectZone12">
...
<input type="hidden" class="check_val">
	 ...
	 // }
								 ...
								 $("body").on('click', '.viewgroup', function() {
                                            ...
                                            if ($("#editActionassign").hasClass('activebtn')) {
                                                ...
                                                if (grp_id !='') {
                                                    ...
                                                    $.fancybox.open({
                                                        ...
                                                        autoSize: true,
                                                        type: "ajax",
                                                        src: '<?= base_url(); ?>UserManage/assignUsertoGroup/' + grp_id,
                                                        ajax: {
                                                            settings: {
                                                                data: '',
                                                                type: 'POST'
                                                ...
                                                let grp_id = $("#delete_zoneremove").attr("data-id");
                                                 ...
                                                 if (grp_id !='') {
                                                    ...
                                                    $.fancybox.open({
                                                        ...
                                                        autoSize: true,
                                                        type: "ajax",
                                                        src: "<?php echo base_url(); ?>UserManage/removeSelectedGroupUsers",
                                                        ajax: {
                                                            settings: {
                                                                data: 'grp_id=' + grp_id,
                                                                type: 'POST'
                                        ...
                                        $('.myModal1usergroup').click(function() {
                                            ...
                                            var modal2 = document.getElementById("myModal1usergroup");
										...
										$('.myModal1usergroupconfig').click(function() {
											...
											var modal3 = document.getElementById("myModal1usergroupconfig");
                    ...
                    <div class="tab right-tabs">
                        ...
                        <div class="table-content">
                            <ul class="nav nav-tabs ">
                                ...
                                <li id="openuserpermissions9090"  class=""><a data-toggle="tab"  href="#home">PERMISSIONS</a></li>
