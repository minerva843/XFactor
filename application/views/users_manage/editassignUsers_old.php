                                ...
                                <script>
                                    $(document).ready(function() {
                                        ...
                                        $('#selectShortBy').change(function () {
                                             $("#ViewSingleData").empty().html('<p><span>CURRENTLY SELECTED : </span> NO USER SELECTED</p>');
                    ...
                    <div class="tab right-tabs">
                        ...
                        <div class="table-content">
                            <ul class="nav nav-tabs ">
                                ...
                                <li class="" id="allgrouppermission474774"><a   data-toggle="tab"  href="#home">PERMISSIONS</a></li>
