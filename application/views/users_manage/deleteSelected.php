                    ...
                    <div class="tab right-tabs">
                        ...
                        <div class="table-content">
                            ...
                            <div class="table_info floor-step">
                                ...
                                <br>
                                <p><b>TO CHECK AGAIN BEFORE <span style="color:red; font-weight: bold;"><?php echo $action; ?></span>, CLICK BACK.</b></p><br />
                                <p><b>ARE YOU SURE YOU WANT TO <span style="color:red; font-weight: bold;"><?php echo $action; ?> </span> <?php if ($selected) {
                                                                                                                                                echo 'THE SELECTED';
                                                                                                                                            } else {
                                                                                                                                                echo 'ALL';
                                                                                                                                            } ?>GROUPS ?</b></p>
