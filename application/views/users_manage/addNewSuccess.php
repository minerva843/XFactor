        ...
        <div class="top-header">
            <div class="row">
                <div class="col-md-9">
                    ...
                    <p> <b><?php echo date('Ymd Gi'); ?>h.</b> THIS WORKSHOP HAS BEEN <?php echo $action; ?>ED.</p>
                </div>
        ...
        <div class="middle-body register-form zone-sucess">
            <div class="row">
	            ...
	            <div class="leftbox-top">
                    ...
                    <div class="zone-info">
					<div class="col-md-12" id="printJS-form-gchat-add">
					...
					<div class="col-md-9">
                        ...
                        <form>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-8">
                                    <div class="zone-label"><?php echo $workshop->created_ip_address; ?></div>
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-8">
                                    <div class="zone-label"><?php echo $workshop->last_edited_ip_address; ?></div>
                                </div>
                            </div>
                ...
                <div class="col-md-3 right-text">
                    <div class="tab right-tabs">
                        ...
                        <div class="table-content">	      
							...
							<p> <span class="current-bold">CURRENTLY SELECTED :</span> <span style="color:black; font-size: 14px;" > <?php echo $workshop->workshop_name; ?></span></p>  
                            ...
                            <div class="form-submit"> 
                                <input type="button" value="PRINT" class="action-btn" onclick="printJS({printable:'printJS-form-gchat-add', type:'html',targetStyles: ['*']})" id="submitSuccback">
