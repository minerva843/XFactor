...
<div class="main-section"> 
    <div class="container">
        ...
        <div class="top-header">
            <div class="row">
                <div class="col-md-9">
                    <h2>GROUP (ASSIGN USERS) <span class="sucess">SUCCESSFUL </span></h2> 
                    <p> <b><?php echo date('Ymd Gi'); ?>h.</b> 
...
<div class="row">
			...
			<div class="form-group row">
				...
				<li  id="group_chat_list3309" class=""><a data-toggle="tab" href="#menu2">PERMISSIONS</a></li>
