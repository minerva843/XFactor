...
<div class="main-section"> 
    <div class="container">
        ...
        <div class="top-header">
            <div class="row">
                <div class="col-md-9">
                    <h2>ASSIGN POSTS (CLEAR <?php if($selected){  }else{echo 'ALL';} ?> ASSIGNMENT ) <span style="color: #00b050;" >SUCCESSFUL</span> </h2>
                   <p><b><?php echo date('Ymd hi'); ?> .</b>CLEAR ALL ASSIGNMENTS MEANS ALL POST ASSIGNMENTS TO INFO ICONS CANNOT BE RETRIEVED IN FUTURE.</p>
                </div>
        ...
        <div class="middle-body register-form zone-sucess">
			...
			<div class="col-md-12" id="printJS-form-post-clearall">
				...
				<li class="active"><a data-toggle="tab" href="#menu1">MAIN MENU</a></li>
					...
					<p><b>ARE YOU SURE YOU WANT TO <span style="color:red">CLEAR <?php if($selected){}else{echo 'ALL';} ?> ASSIGNMENT</span>?</b></p>
                            ...
                            <div class="form-submit"> 
                                <input type="button" value="PRINT" class="action-btn" onclick="printJS({printable:'printJS-form-post-clearall', type:'html',targetStyles: ['*']})" id="submitSuccback">
...
function myFunction() {
  ...
  x.disabled = true;
        ...
        autoSize  : true,
        type        : "ajax",
        src         : "<?php echo base_url(); ?>post/postassignment",
        ajax: { 
