...
<div class="main-section fancybox-content" id="add-floor" style=""> 
    <div class="container">
        ...
        <div class="top-header">
            <div class="row">
                <div class="col-md-9">  
                    <h2>POST (EDIT) <span class="sucess">SUCCESSFUL </span></h2>
                    <p> <b><?php echo date('Ymd hi'); ?>h.</b>  THIS POST HAS BEEN EDITED.</p>
                </div>
        ...
        <div class="middle-body register-form zone-sucess"> 
            <div class="row">
	            ...
	            <div class="leftbox-top">
					...
					<div class="col-md-9" id="printJS-form-post-edit-successfull2">
				...
				<li><a data-toggle="tab" href="#menu1">ASSIGN POST</a></li>
                            ...
                            <div class="table_info floor-step">
                                <p><span class="current-bold">CURRENTLY SELECTED :</span> <span style="color:black;font-size: 14px;">POST(EDIT)</span></p>
                               <p>WHAT’S NEXT</p>
...
CLICK ASSIGN POSTS.</p>
                            ...
                            <div class="form-submit"> 
                                <input type="button" value="PRINT" class="action-btn" onclick="printJS({printable:'printJS-form-post-edit-successfull2', type:'html',targetStyles: ['*']})" id="submitSuccback">
