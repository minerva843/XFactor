...
<div class="main-section"> 
    <div class="container">
        ...
        <div class="top-header">
            <div class="row">
                <div class="col-md-9">
                    <h2>ASSIGN POSTS (CLEAR <?php if($selected){  }else{echo 'ALL';} ?> ASSIGNMENT ) </h2>
                   <p style="color:red">
				  CLEAR ALL ASSIGNMENTS MEANS ALL POST ASSIGNMENTS TO INFO ICONS CANNOT BE RETRIEVED IN FUTURE.
				   </p>
                </div>
        ...
        <div class="middle-body register-form zone-sucess content-delete-single">
            <div class="row">
				...
				<div class="leftbox-top">
					<h5> ALL POST ASSIGNMENTS TO BE CLEARED ARE LISTED BELOW :</h5>
					</div>  
			 ...
			 <div class="row">
					...
					<div class="col-md-9">
                        ...
                        <form>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-8">
                                    <div class="zone-label"><?php if($data1->website){ echo $data1->website; }else{ echo "NIL"; }?>
									</div>
                                </div>
                            </div>
							<div class="form-group row">
                                ...
                                <div class="col-sm-8">
                                    <div class="zone-label"><?php if($data1->btn_url){ echo $data1->btn_url; }else{ echo "NIL"; }?>
									</div>
                                </div>
                            </div>
							<div class="form-group row">
				...
				<li class="active"><a data-toggle="tab" href="#menu1">MAIN MENU</a></li>
                            ...
                            <div class="table_info floor-step">
                                ...
                                <p><span class="current-bold">CURRENTLY SELECTED :</span> <span style="color:black;font-size: 14px;" >ALL POSTS</span></p>
								<br>
                          <p><b>TO CHECK AGAIN BEFORE <span style="color:red"> CLEAR <?php if($selected){}else{echo 'ALL';} ?> ASSIGNMENT</span> ,  CLICK BACK.</b></p>
					<p><b>ARE YOU SURE YOU WANT TO <span style="color:red">CLEAR <?php if($selected){}else{echo 'ALL';} ?> ASSIGNMENT</span>?</b></p>
                            ...
                            <div class="form-submit"> 
                                ...
                                <input type="submit" value="<?php if($selected){echo 'CLEAR ASSIGNMENT';}else{echo 'CLEAR ALL ASSIGNMENT';} ?>" class="action-btn" name="submit" id="submitbtn">
                            </div>
                        </div>
                    </div>
                </div>
...
var strids="<?php print($ids);?>"; 
 ...
 // console.log(strids);     
       $.fancybox.open({
        ...
        autoSize  : true,
        type        : "ajax",
        src         : "<?php echo base_url(); ?>post/clearSelectedSuccess",
        ajax: { 
