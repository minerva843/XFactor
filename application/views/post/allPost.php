...
<div class="main-section poject-listing-QT" id="floor-sort"> 
    <div class="container">
        ...
        <div class="top-header">
            <div class="row">
                <div class="col-md-9">
                    <h2>POSTS <span id="actiontopText"style="font-size:18px;" ></span></h2>
                </div>
                ...
                <div class="col-md-9">  <?php // print_r($zone);  ?>
                        ...
                        <div class="floor-sec"> 
							...
							<option value="earliest_edit">last edited(earliest first)</option>
                                ...
                                <div class="floor-table project-table  project-table-listing">
                                    <P>ALL POSTS ARE LISTED BELOW :</P> <br>
                                ...
                                <div id="myModal1" class="modal delete-sorting">
									...
									<div class="modal-body">
                                        <h4>POSTS (EDIT) <span style="color:red ;font-weight:bold;">NOT SUCCESSFUL </span></h4>
					...
					<div class="modal-footer text-right"> <span class="close">OK</span> </div>									
                                ...
                                <div id="myModal" class="modal delete-sorting">
                                    ...
                                    <div class="modal-content">
					<div class="modal-body">
                                        <h4> POSTS (DELETE) <span style="color:red ;font-weight:bold;">NOT SUCCESSFUL </span></h4>   
                                        <p>NO ENTRY SELECTED.</p>
                                            ...
                                            if($(this).hasClass('activebtn')){
											    ...
											    ///  $(".chk2").css("display","none");
											      $("#ViewSingleData").find("#multipleprojectselect").text("NO POST SELECTED");
												   $("#ViewSingleData").empty().html('<p><span class="current-bold">CURRENTLY SELECTED : </span> NO POST SELECTED</p><p><span class="current-bold">CURRENTLY VIEWING : </span> NO POST SELECTED</p>');
                                    ...
                                    $(document).ready(function () {
                                        ...
                                        $("body").on('click', '#PostdeleteAll', function () {
											...
											$.fancybox.open({
												...
												autoSize  : true,
												type        : "ajax",
												src         : "<?php echo base_url(); ?>post/deleteSelected",
												ajax: { 
                                        ...
                                        $("body").on('click', '#AddProject', function () {
                                            ...
                                            $.fancybox.open({
												...
												autoSize  : true,
												type        : "ajax",
												src         : "<?php echo base_url(); ?>post/addpost",
												ajax: { 
												   settings: { data : 'project=<?=$project;?>', type : 'POST' }
												},
												touch: false,
                                        ...
                                        if($("#PosteditProject").hasClass('activebtn')){
                                            ...
                                            $.fancybox.getInstance('close');
											 ...
											 $.fancybox.open({
												...
												autoSize  : true,
												type        : "ajax",
												src         : "<?php echo base_url(); ?>post/editstep1/" + currentid,
												ajax: { 
												   settings: { data : 'project=<?=$project;?>', type : 'POST' }
												},
												touch: false,
        ...
        touch: false,
					...
					// }else {
                                    ...
                                    function reply_click(clicked_id)
                                    {
                                        ...
                                        $.ajax({
                                            url: "<?= base_url(); ?>post/searchSingleData",
                                            method: "GET",
                    ...
                    <div class="tab right-tabs">
                        ...
                        <div class="table-content">	  
                            <ul class="nav nav-tabs ">
								...
								<li><a data-toggle="tab" href="" id="AllAssignment">ALL ASSIGNMENTS</a></li>
								 <li><a data-toggle="tab" href="" id="posticon_assignment">ASSIGN POST</a></li>
