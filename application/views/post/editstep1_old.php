...
<form action="<?php echo base_url(); ?>post/addstep1post" method="POST" id="addZone">
        <div class="top-header">
            <div class="row">
                ...
                <div class="col-md-3">
                    <div class="top-close"><input type="button" value="CLOSE" class="close-btn" name="submit" id="close-btnstep1post"></div>
                </div>
            </div>   
        </div>	   
				...
				<!-- 	<h5> ENTER ZONE DETAILS THAT ARE LISTED BELOW :</h5> -->
                    ...
                    <div class="zone-info add-conents post-video-listing">
						...
						<div class="form-group row">
							...
							<div class="col-sm-5">
								<input type="text" name="post_title" class="post_title" value="<?php if(!empty($data1->post_title)){ echo $data1->post_title; } ?>" class="form-control" id="post_title" placeholder="Enter POST TITLE">
							</div>
						</div>
	...
	toolbar: [
		...
		{ name: 'basicstyles', items: [ 'Bold', 'Italic' ] }
							...
							<div class="form-group row  rmv_btn_main_2">
							...
							<div class="col-sm-5">
								...
								<?php if(!empty($files[0]->file_name)){
									echo '<div class="file-select-name filrev" id="noFile">'.$files[0]->file_name.'</div><div class="remove_1 rmv_btn bnt_rem">REMOVE</div>'; }else{ ?>
					...
					<div class="form-group row rmv_btn_main_2">
							...
							<div class="col-sm-5">
								...
								<?php if(!empty($files[1]->file_name)){
									echo '<div class="file-select-name filrev" id="noFile2">'.$files[1]->file_name.'</div><div class="remove_2 rmv_btn bnt_rem">REMOVE</div>'; }else{ ?>
							<div class="file-upload">
								  <div class="file-select">
						...
						<div class="form-group row rmv_btn_main_2">
							...
							<div class="col-sm-5">
								...
								<?php if(!empty($files[2]->file_name)){
									echo '<div class="file-select-name filrev" id="noFile3">'.$files[2]->file_name.'</div><div class="remove_3 rmv_btn bnt_rem">REMOVE</div>'; }else{ ?>
							<div class="file-upload">
								  <div class="file-select">
					...
					<div class="form-group row rmv_btn_main_2">
							...
							<div class="col-sm-5">
								...
								<?php if(!empty($files[3]->file_name)){
									echo '<div class="file-select-name filrev" id="noFile4">'.$files[3]->file_name.'</div><div class="remove_4 rmv_btn bnt_rem">REMOVE</div>'; }else{ ?>
							<div class="file-upload">
								  <div class="file-select">
					...
					<div class="form-group row  post_visual_view rmv_btn_main_2">
							<label for="colFormLabelLg" class="col-sm-4 col-form-label">POST VISUALS /VIDEOS</label>
							<div class="col-sm-5">
								<!-- <input type="file" name="image" class="form-control" class="file" id="file" onchange="ValidateSingleInput(this);">  -->
								<?php if(!empty($files[4]->file_name)){
									echo '<div class="file-select-name filrev" id="noFile5">'.$files[4]->file_name.'</div><div class="remove_5 rmv_btn bnt_rem">REMOVE</div>'; }else{ ?>
							<div class="file-upload">
								  <div class="file-select">
                    ...
                    <div class="tab right-tabs">
                        ...
                        <div class="table-content">	  
                            ...
                            <div class="table_info floor-step">
                                <p><span style="color: #00b050;">CURRENTLY SELECTED :</span> POST (EDIT)</p>
                                <h5>STEP 1 OF 2</h5>
   ...
   $.ajax({
    ...
    beforeSend: function(){
     ...
     success: function (response) {
			...
			if (data) {  
				$.fancybox.open({ 
					src: '<?php echo base_url(); ?>post/editstep2/'+data,
					type: 'ajax',    
					opts: {
...
//        
        ...
        $('body').on('click', '#close-btnstep1post', function () {
            $.fancybox.close();
             window.location.href = "<?php echo base_url(); ?>post/deleteJunkRecord/<?php echo $data1->id; ?>/<?php echo $data1->group_id; ?>/<?php echo $data1->project_id; ?>/EDIT/1";
