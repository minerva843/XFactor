			...
			<div class="row">
				<?php if (empty($data)) { ?>
					<div class="col-md-9 place-filter">
						<div class="post-contset">
							<p class="po-contentset">THIS POST IS NOT ASSIGNED TO ANY SPACE IN THIS ZONE.</p>
						</div>
					</div>
					<script>
										...
										<div class="mySlides1" style="display:none;">
											<?php foreach ($icons as $icon) {
												...
												if (!empty($data->post_title)) { ?>
													...
													<div data-toggle="modal" data-target="#place_popup<?= $popupAI; ?>" class="myhistory draggable_<?= $icon->id; ?>" data-boxid="<?= $icon->id; ?>" style="position: absolute; z-index:1; top:<?= $position->top; ?>;left:<?= $position->left; ?>;cursor: pointer;">
																		...
																		<div class="tooltips">
																			...
																			<div class="quick-intro">
																				...
																				<div class="chat-close">
																					<!--<a href="#" class="chat-to-owner rem_close" data-dismiss="modal"> CHAT </a> <a href="#" class="quik-intro rem_close" data-dismiss="modal">READ QUICK INTRO </a> --> <a href="#" class="rem_close" data-dismiss="modal">CLOSE</a>
																				</div>
																			</div>
											...
											<?php } ?>
											<img id="demo-4" class="floorimg snaptarget33 icon-post_front1" src="<?php echo base_url() . 'temp/' . $images->file_name; ?>" alt="your image">
										</div>
									</div>
								</div>
							</div>
				...
				<script>
					...
					// $("#chat_tabb").click(function() {
					// 	//alert('hii');
					// 	//alert($('.chat-inscroll')[0].scrollHeight);
					...
					// var targetNode = document.getElementsByClassName('chat-area')[0];
					...
					$('.myhistory').click(function() {
						...
						//$('.place-model-popup').removeClass('show');
						//$('.place-model-popup').addClass('fade');
						//$('.place-model-popup').hide();
						...
						$.ajax({
							...
							data: {
								module_name: 'INFO ICON',
								module_refid: icon_id,
						...
						<div class="table-content">
							...
							<div class="tab-content chat">
									...
									<div class="table_info">
										...
										<div class="details-tab">   
											...
											<div class="details-in">
												...
												if(!empty($videos)){ ?>
										<p> AT THE END OF THE VIDEO OR WHEN YOU SKIP VIDEO, AN IMAGE WITH INFO ICONS WILL APPEAR. </p>
										<p>CLICK ON ANY INFO ICON TO DISPLAY INFORMATION / PROMOTIONS / CONTEST RULES.</p>  
											
										<?php }else{ ?>
											<p> NO POSTS AVAILABLE.</p>
											<p> THE PLACE OWNER DID NOT POST ANY INFO.</p>
										<?php } ?>
												<!-- <p> SELECT ANY INFO ICON TO DISPLAY DETAILS FIRST. </p> -->
											</div>
								...
								<div id="chat5" class="container tab-pane">
									<!-- <a href="javascript:void(0)" id="chat_tabb">Trigger</a> -->
								...
								<div id="chat6" class="container tab-pane">
									<div class="table_info quick-intro quik-detail">
										<?php if(!empty($videos)){ ?>
										<p> NO INFO ICON SELECTED. <br><br> SELECT ANY INFO ICON TO USE THIS FEATURE. </p>
