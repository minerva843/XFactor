				...
				<?php if (empty($data)) { ?>
					<div class="col-md-9 place-filter">
						<div class="post-contset">
							<p class="po-contentset">Post is not assigend to any content set</p>
						</div>
					</div>
					<script>
																		...
																		<div class="tooltips">
																			...
																			<div class="quick-intro">
																				...
																				<div class="chat-close">
																					<!--<a href="#" class="chat-to-owner rem_close" data-dismiss="modal"> CHAT </a> <a href="#" class="quik-intro rem_close" data-dismiss="modal">READ QUICK INTRO </a> --> <a href="#" class="rem_close" data-dismiss="modal">CLOSE</a> </div>
																			</div>
												...
												<script>
													$(document).ready(function() {
														...
														$('.draggable_<?= $icon->id; ?>').click(function() {
															...
															// data: {module_name:'INFO ICON',module_refid:icon_id,project_id:project_id,zone_id:zone_id,floor_id:floor_id}, 
															// success: function(data)
															// {
														...
														$('.draggable_<?php echo $iconid; ?>').click();
										...
										<?php if ($userdetails->chat_enable == 0) {
											...
											<div class="nearme-box chat-top-profile">
												<div class="nearme-box clearfix">
													<?php if ($postguest->useravatar) { ?>
														<img src="<?php echo base_url('assets/svgavatar/for_upload/svgavatars/temp-avatars/' . $postguest->useravatar); ?>" class="img-fluid">
													<?php } else { ?>
														<img src="<?php echo base_url(); ?>assets/images/GUEST_MALE.png" class="img-fluid">
													<?php } ?>
													<div class="nearme-detail">
														<p><?php echo $postguest->guest_type . ', ' . $postguest->salutation . ' ' . $postguest->first_name . ' ' . $postguest->last_name . ', ' . $postguest->company; ?>
														</p>
													</div>
												</div>
											</div>
