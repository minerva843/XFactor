...
<div class="main-section floor_steps" id="floor-sort"> 
    <div class="container">
        ...
        <div class="top-header">
            <div class="row">
                <div class="col-md-9">
                    <h2>VIDEO STREAM <span id="actiontopText"style="font-size:18px;" ></span> </h2>
                </div>
                    ...
                    <div class="floor-sec"> 
						<div class="tab-listing">
						   ...
						   <select class="dropdown" id="selectFloor">
							<option value="">SHOW ALL VIDEO STREAM</option>
							<!--option value="all_document">ALL DOCUMENTS</option>
							<option value="all_image">ALL IMAGE FILES</option>
							<option value="all_video">ALL AUDIO FILES</option>
							<option value="all_audio">ALL VIDEO FILES</option-->
						  </select>
						  </div>  
						  ...
						  <select class="dropdown" id="selectShortBy">
							...
							<option value="video_source">VIDEO STREAM SOURCE  (A-Z)</option>
							<option value="video_name">VIDEO STREAM NAME (A-Z)</option>
							...
							<div class="col-md-1"><button class="src-btn1  coledit" id="VideoeditAction" >EDIT</button></div>
							<div class="col-md-1"><button class="src-btn1 VideodeleteAction" id="VideodeleteAction">DELETE</button></div>
							<div class="col-md-1"><button class="src-btn1" id="VideodeleteAll">DELETE ALL</button></div>
						  </div>

				<div class="floor-table floor-sorting_list video_floor_shorting">
					<P>All VIDEO STREAM are listed Below:</P>
  ...
  $(".SER").on("keyup", function() {
    ...
    // });
	  // }
                                          ...
                                          $("#VideoeditAction").click(function () {
currentid="";
                                           $("#ViewSingleData").empty().html('<p><span class="current-bold">CURRENTLY SELECTED : </span> NO VIDEO STREAM SELECTED</p>');
											$('.rightcheck ').css("display","none");
												
										    $(".deletClas"). prop("checked", false);
                                            $("#VideodeleteAction").removeClass("activebtn");
									...
									$("#VideodeleteAction").click(function () {
                                           
                                        											//alert("delete");
                                            $("#VideoeditAction").removeClass("activebtn");
											$('.form-submit').show();
                                            ...
                                            if($(this).hasClass('activebtn')){
                                                ...
                                                $('.deletClas:checked').each(function () {
                                                 val23.push($('.deletClas:checked').val());
											      ...
											      $("#ViewSingleData").find("#multipleprojectselect").text("NO VIDEO STREAM SELECTED");
												  $("#ViewSingleData").empty().html('<p><span class="current-bold">CURRENTLY SELECTED : </span> NO VIDEO STREAM SELECTED</p><p><span class="current-bold">CURRENTLY VIEWING : </span> NO VIDEO STREAM SELECTED</p>');
  ...
  <div class="modal-body">
    <h4>VIDEO STREAM (DELETE) <span style="color:red">NOT SUCCESSFUL</span></h4>  
	
    <p style="">NO ENTRY SELECTED.</p>
    <p style="">USE THE CHECK BOX ON THE LEFT OF EACH ENTRY TO SELECT.</p>
	</div>
...
<div id="myModal1" class="modal delete-sorting">
  ...
  <div class="modal-content">   
   <div class="modal-body">
   <!-- <h4><span style="color:red ;font-weight:bold;"> PLEASE SELECT A VIDEO STREAM FIRST.</span></h4>-->
	<h4>VIDEO STREAM (EDIT) <span style="color:red ;font-weight:bold;">NOT SUCCESSFUL </span></h4>
...
<script>
    ...
    $(document).ready(function () {
		...
		$("body").on('click','#VideodeleteAll',function(){
        ...
        autoSize  : true,
        type        : "ajax",
        src         : "<?php echo base_url(); ?>video/deleteSelected",
        ajax: { 
        ...
        autoSize  : true,
        type        : "ajax",
        src         : "<?php echo base_url(); ?>video/addStep1",
        ajax: { 
           settings: { data : 'project=<?=$project?>', type : 'POST' }
        },
        touch: false,
...
/* $(".VideodeleteAction").click(function(){
	$('.deletClass').toggle();
	$('.VideodeleteAction').toggleClass( "activebtn" );
	$('.form-submit').toggle(); 
...
$("#Videosubmitbtn").click(function() {
	...
	if($("#VideoeditAction").hasClass('activebtn')){
        ...
        autoSize  : true,
        type        : "ajax",
        src         : '<?php echo base_url(); ?>video/editStep/'+currentid,
        ajax: { 
           settings: { data : 'project=<?=$project;?>', type : 'POST' }
        },
        touch: false,
                                    ...
                                    function check_multiple_select() {
                                        ...
                                        if (val23.length) {
                                            var val22 = val2.length + 1;
											 ...
											 if($("#VideodeleteAction").hasClass('activebtn')){                                                 
                                                  $("#ViewSingleData").find("#multipleprojectselect").text("NO VIDEO STREAM SELECTED");
      ...
      //     alert(val2.length);
          //$('#ViewSingleData').html('<tr><td colspan="2" class="top-fp"><p><span>CURRENTLY SELECTED:</span>MULTIPLE Floor PLANS </p></td></tr>');
           ...
           //}else{
			  ...
			  $.ajax({
			   url:"<?=base_url();?>video/searchSingleData",
			   method:"GET", 
...
<ul class="nav nav-tabs ">
						...
						<div class="tab-content" id="nav-tabContent">
                            ...
                            <div class="form-submit delete-sorting" style="display:none;"> 
                                ...
                                <input type="button" value="Next" class="action-btn" name="submit" id="Videosubmitbtn">
                            </div>
                        </div>
                    </div>
                </div>
