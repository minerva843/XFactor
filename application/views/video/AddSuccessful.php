...
<div class="main-section fancybox-content" id="add-floor" style=""> 
    <div class="container">
        ...
        <div class="top-header">
            <div class="row">
                <div class="col-md-9">  
                    <h2>VIDEO STREAM (ADD) <span class="sucess">SUCCESSFUL </span></h2>
                    <p> <b><?php echo date('Ymd hi'); ?>h.</b>  THIS VIDEO STREAM HAS BEEN ADDED.</p>
                </div>
        ...
        <div class="middle-body register-form zone-sucess"> 
            <div class="row">
	            ...
	            <div class="leftbox-top">
					...
					<div class="col-md-12" id="printJS-form-video-add">
				...
				<li class="active"><a data-toggle="tab" href="#menu1">MAIN MENU</a></li>
                            ...
                            <div class="table_info floor-step">
                                <p style="color:#00b050!important;"><span class="current-bold">CURRENTLY SELECTED :</span> <span style="color:black;font-size: 14px;">VIDEO STREAM (ADD)</span></p>
                            ...
                            <div class="form-submit"> 
                                <input type="button" value="PRINT" class="action-btn" onclick="printJS({printable:'printJS-form-video-add', type:'html',targetStyles: ['*']})" id="submitSuccback">
                                <input type="button" value="DONE" class="action-btn" name="submit" id="toHome3435">
                            </div>
                        </div>
                    </div>
                </div>
...
<script>
 $(document).ready(function(){
	...
	$("body").on('click','#toHome3435',function(){
