                    ...
                    <div class="tab right-tabs">
                        ...
                        <div class="table-content">	  
							...
							<div class="current-status">
								<p><span class="current-bold">CURRENTLY Selected : </span><?php if($data->video_stream_name){ echo $data->video_stream_name;}?></p>
								</div>
...
var video_stream_url=$('#video_stream_url').val();
 ...
 formdata.append('video_stream_source', video_stream_source);
   ...
   $.ajax({
     ...
     url: '<?php echo base_url(); ?>video/addstepPOSt/<?=$data->id;?>', 
     type: 'post',
     data: formdata,
     dataType: 'json',
     contentType: false,
     ...
     success: function (response) {
			...
			if (data) {
				$.fancybox.open({
					src: '<?php echo base_url(); ?>video/EditSuccessful/'+data,
					type: 'ajax',    
					opts: {
