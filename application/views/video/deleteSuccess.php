...
<div class="main-section"> 
    <div class="container">
        ...
        <div class="top-header">
            <div class="row">
                <div class="col-md-9">
                    <h2>VIDEO STREAM (DELETE<?php if($selected){ }else{echo ' ALL';} ?>) <span style="color: #00b050;" >SUCCESSFUL</span> </h2>
					<p> <b><?php echo date('Ymd hi'); ?>h.</b>  <?php if($selected){ echo 'ALL SELECTED'; }else{echo 'ALL';} ?> VIDEO STREAM HAVE BEEN DELETED</p>
        ...
        <div class="middle-body register-form zone-sucess">
            <div class="row">
				...
				<div class="leftbox-top">
					<h5> <?php if($selected){ echo 'ALL SELECTED'; }else{echo 'ALL';} ?> VIDEO STREAMS DETAILS ARE LISTED BELOW : </h5>
					</div>  
                     <?php //print_r($data_files_content['content']); ?>
                    <div class="zone-info delete-floorplan"> 
			<div class="col-md-12" id="printJS-form-video-delete">
			 ...
			 <div class="row">
				...
				<li class="active"><a data-toggle="tab" href="#menu1">MAIN MENU</a></li>
                            ...
                            <div class="table_info floor-step">
								...
								?></span></p>
								<br>
             <!--        <p><b>TO CHECK AGAIN BEFORE <span style="color:red;font-weight: bold;">DELETE <?php if($selected){echo 'SELECTED';}else{echo 'ALL';} ?></span> , CLICK BACK.</b></p>
				<p><b>ARE YOU SURE YOU WANT TO <span style="color:red;font-weight: bold;">DELETE <?php if($selected){echo 'SELECTED';}else{echo 'ALL';} ?></span> , VIDEO STREAM?</b></p>
                            ...
                            <div class="form-submit"> 
                                <input type="button" value="PRINT" class="action-btn" onclick="printJS({printable:'printJS-form-video-delete', type:'html',targetStyles: ['*']})" id="submitSuccback">
