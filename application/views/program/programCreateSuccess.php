                ...
                <div class="col-md-3 right-text">
                    <div class="tab right-tabs">
						 ...
						 <div class="current-status">
								<p class="current-status-1" style="color:#00b050!important;">CURRENTLY SELECTED : </p><p> PROGRAM(ADD)
                                </p></div>
  ...
  x.disabled = true;
        ...
        $("body").on('click','#btn5',function(){
           ...
           $.fancybox.getInstance('close');
            $.fancybox.open({
                src: '<?=base_url();?>program/addprogram/<?php echo $data1->id;?>',
                type: 'ajax',
                ajax: {
		...
		$("body").on('click','#btn555',function(){
           ...
           $.fancybox.getInstance('close');
            $.fancybox.open({
                src: '<?=base_url();?>program/addProgramGuestlist/<?php echo $data1->id;?>',
                type: 'ajax',
                ajax: {
                    settings: {data: 'ABC', type: 'POST'}
                },
