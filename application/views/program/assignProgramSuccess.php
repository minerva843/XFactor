...
<div class="main-section" id="add-floor"> 
 ...
 <form method="POST" action="<?=base_url();?>program/assignProgramstep2" class="register-form_1" id="register-form" enctype="multipart/form-data">
        <div class="top-header">
            <div class="row">
                <div class="col-md-9">
					...
					<p> <b><?php echo date('Ymd hi'); ?> .</b> THIS PROGRAM HAS BEEN ASSIGNED.</p>
                </div> 
        ...
        <div class="middle-body register-form program-tabs assign-program-pg">
            ...
            <div class="row">
				   <div class="col-md-9"id="printJS-form-program-assign">  <?php // print_r($zone); ?>
				   <div class="">
                    ...
                    <div class="tab right-tabs">
                        ...
                        <div class="table-content">	  
                            ...
                            <div class="form-submit"> 
								<a class="action-btn" id="btn5" onclick="printJS({printable:'printJS-form-program-assign', type:'html',targetStyles: ['*']})">PRINT</a>
								<a class="action-btn Next" id="btn5" >DONE</a>
