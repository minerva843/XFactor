        ...
        <div class="top-header">
            <div class="row">
                <div class="col-md-9"><?php //print_r($zone[0]);  
                                        ?>
                    <h2>PROGRAM (DELETE ALL)<span class="sucess">SUCCESSFUL </span></h2>
                    <p><b><?php echo date('Ymd hi'); ?>h.</b> ALL PROGRAMS HAS BEEN DELETED.</p>
                </div>
                    ...
                    <div class="row">
                        <div class="header-title">
                            <div class="leftbox-top">
                                <h5>ALL PROGRAMS TO BE DELETED ARE LISTED BELOW : </h5>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="tab right-tabs">
                        ...
                        <div class="table-content">
                            ...
                            <div class="table_info floor-step">
                                ...
                                <p><span class="current-bold">CURRENTLY SELECTED :</span> <span style="color:black;font-size: 14px;font-weight: bold;">ALL PROGRAMS</span></p>
...
<script>
    ...
    $("body").on('click', '#btn555', function() {
        ...
        $.fancybox.open({
            ...
            ajax: {
                settings: {
                    data: 'project=<?= $_SESSION["DeleteData"][0]["project_id"]; ?>',
                    type: 'POST'
                }
            },
            touch: false,
