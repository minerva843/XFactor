        ...
        <div class="top-header">
            <div class="row">
                <div class="col-md-9"><?php //print_r($zone[0]);  ?>  
                    <h2>PROGRAM (CLEAR ASSIGNMENT) <span class="sucess">SUCCESSFUL </span></h2>
                    <p><b><?php echo date('Ymd hi'); ?>h.</b>ALL SELECTED PROGRAM ASSIGNMENTS HAVE BEEN CLEARED.</p>
                </div>
        ...
        <div class="middle-body register-form zone-sucess">
			...
			<div class="select-box">
				...
				<div class="row">
					...
					<h5>ALL PROGRAM ASSIGNMENTS THAT ARE CLEARED ARE LISTED BELOW : </h5>
					</div>
					</div>
					</div>	
					...
					<div class="row" id="printJS-form-program-clearselected">
					...
					<?php foreach($_SESSION['SelectedDelete'] as $data){?>
                        <h3>PROGRAM INFO</h3>  				
							<div class="form-group row">
                                <label for="colFormLabelSm" class="col-sm-3 col-form-label col-form-label-sm">PROGRAM STATUS </label>
                                <div class="col-sm-5">
						   ...
						   <div class="form-group row">
                                <label for="colFormLabelSm" class="col-sm-3 col-form-label col-form-label-sm">PROGRAM START DATE & TIME</label>
                                <div class="col-sm-5">
                                    <div class="zone-label"><?=$data['program_start_date_time'] ?></div>
                                </div>
                            </div>
							<div class="form-group row">
                                <label for="colFormLabelSm" class="col-sm-3 col-form-label col-form-label-sm">PROGRAM END DATE & TIME</label>
                                <div class="col-sm-5">
                                    <div class="zone-label"><?=$data['program_end_date_time']?></div>
                                </div>
                            </div>
							<div class="form-group row">
                                <label for="colFormLabelSm" class="col-sm-3 col-form-label col-form-label-sm">PROGRAM PRESENTER</label>
                                <div class="col-sm-5">
                                    <div class="zone-label"><?php 
									$programPresenter='';
							...
							<div class="form-group row">
                                <label for="colFormLabelSm" class="col-sm-3 col-form-label col-form-label-sm">PROGRAM LOCATION</label>
                                <div class="col-sm-5">
                                    <div class="zone-label"><?=$data['program_location']?></div>
                                </div>
                            </div>
							<div class="form-group row">
                                <label for="colFormLabelSm" class="col-sm-3 col-form-label col-form-label-sm">PROGRAM TITLE</label>
                                <div class="col-sm-5">
							...
							<div class="form-group row">
                                <label for="colFormLabelSm" class="col-sm-3 col-form-label col-form-label-sm">PROGRAM DETAILS</label>
                                <div class="col-sm-5">
                                    <div class="zone-label"><?=$data['program_details']?></div>
                                </div>
                            </div>
							<div class="form-group row">
                                <label for="colFormLabelSm" class="col-sm-3 col-form-label col-form-label-sm">PROGRAM VISUAL</label>
								<?php $this->db->select('*');
							...
							<div class="form-group row">
                                <label for="colFormLabelSm" class="col-sm-3 col-form-label col-form-label-sm">GROUP STATUS</label>
                                <div class="col-sm-5">
                                    <div class="zone-label"><?=$data['group_status']?></div>
                                </div>
                            </div>
							<div class="form-group row">
                                <label for="colFormLabelSm" class="col-sm-3 col-form-label col-form-label-sm">PROJECT ID</label>
                                <div class="col-sm-5">
                                    <div class="zone-label"><?=$data['proj_id']?></div>
                                </div>
                            </div>
							<div class="form-group row">
                                <label for="colFormLabelSm" class="col-sm-3 col-form-label col-form-label-sm">FLOOR PLAN ID</label>
                                <div class="col-sm-5">
							...
							<div class="form-group row">
                                <label for="colFormLabelSm" class="col-sm-3 col-form-label col-form-label-sm">PROGRAM ID</label>
                                <div class="col-sm-5">
                ...
                <div class="col-md-3 right-text">
                    <div class="tab right-tabs">
						  ...
						  <p><span class="current-bold">CURRENTLY SELECTED :</span> <span style="color:black;font-size: 14px;" ><?php if($_SESSION['Singledata'] == 1){
						 ...
						 <div class="form-submit">
							...
							<input type="button" value="PRINT" class="action-btn" onclick="printJS({printable:'printJS-form-program-clearselected', type:'html',targetStyles: ['*']})" id="submitSuccback">
