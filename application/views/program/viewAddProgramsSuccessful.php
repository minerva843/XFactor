...
<div class="main-section fancybox-content" id="add-floor" style="">
    <div class="container">
        ...
        <div class="top-header">
            <div class="row">
                <div class="col-md-9">
                    <h2>PROGRAM (ADD) <span class="sucess">SUCCESSFUL </span></h2>
                    <p> <b><?php echo date('Ymd hi'); ?>h.</b> THIS PROGRAM HAS BEEN ADDED.</p>
                </div>
            ...
            <div class="row">
                <div class="col-md-9">
                    ...
                    <div class="zone-info project-reg-sucess">
                        ...
                        <div class="col-md-12" id="printJS-form-program-addprogram">
                    ...
                    <div class="tab right-tabs">
                        ...
                        <div class="table-content">
                            ...
                            <div class="table_info floor-step">
                                <div class="status">
                                    <p><span class="current-bold">CURRENTLY SELECTED :</span> <span style="color:black;font-size: 14px;">PROGRAM (ADD)</span></p>
                                    <h5>WHAT’S NEXT</h5>
                            ...
                            <div class="form-submit">
                                <input type="button" value="PRINT" class="action-btn" onclick="printJS({printable:'printJS-form-program-addprogram', type:'html',targetStyles: ['*']})" id="submitSuccback">
        ...
        <div class="footer">2019 – 2020 .<b>XPLATFORM</b>. </div>
