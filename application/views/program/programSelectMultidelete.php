        ...
        <div class="top-header">
            <div class="row">
                <div class="col-md-9"><?php //print_r($zone[0]);  ?>  
                    <h2>PROGRAM (DELETE)</h2>
                    <p style='color:red;'> DELETE MEANS ALL SELECTED PROGRAMS AND RELATED DATA CANNOT BE RETRIEVED IN FUTURE. </p>
                </div>
                ...
                <div class="col-md-3 right-text master-floor-left">
                    <div class="tab right-tabs">
						  ...
						  <p><span class="current-bold">CURRENTLY SELECTED :</span> <span style="color:black;font-size: 14px;font-weight: bold;" ><?php if($_SESSION['Singledata'] == 1){
						    ...
						    <p><b>ARE YOU SURE YOU WANT TO <span style="color:red;font-weight:bold !important;">DELETE </span> THE SELECTED PROGRAMS?</b></p>
							</div>
...
function myFunction() {
  ...
  x.disabled = true;
		...
		$("body").on('click','#btn555',function(){
           ...
           $.fancybox.getInstance('close');
            $.fancybox.open({
                src: '<?=base_url();?>program/ProgramselecteddeleteSuccess',
                type: 'ajax',
                ajax: {
                    settings: {data: 'ABC', type: 'POST'}
                },
