        ...
        <div class="top-header">
            <div class="row">
                <div class="col-md-9"><?php //print_r($zone[0]);  ?>  
                    <h2>PROGRAM (CLEAR ALL ASSIGNMENT)</h2>
                    <p style='color:red;'> CLEAR ALL ASSIGNMENT MEANS ALL PROGRAM ASSIGNMENTS CANNOT BE RETRIEVED IN FUTURE.</p>
                </div>
                ...
                <div class="col-md-3 right-text">
                    <div class="tab right-tabs">
						  ...
						  <p><span class="current-bold">CURRENTLY SELECTED :</span> <span style="color:black;font-size: 14px;font-weight: bold;" ><?php if($_SESSION['Singledata'] == 1){
								...
								<br>
                                <p><b>TO CHECK AGAIN BEFORE <span style="color:red">CLEAR ALL ASSIGNMENT </span>,CLICK BACK.</b></p>
						    <p><b>ARE YOU SURE YOU WANT TO <span style="color:red">CLEAR ALL ASSIGNMENT </span>, FOR PROGRAMS?</b></p>
						 ...
						 <div class="form-submit">
							...
							<a class="action-btn" id="btn5" >Back</a>
                                <input type="submit" value="CLEAR ALL ASSIGNMENT" class="action-btn" name="submit" id="btn555">
                        </div>
						</div>
                </div>
  ...
  x.disabled = true;
		...
		$("body").on('click','#btn555',function(){
           ...
           $.fancybox.getInstance('close');
			...
			autoSize  : true,
			type        : "ajax",
			src         : "<?php echo base_url(); ?>program/clearAllAssignmentSuccess",
			ajax: { 
			   settings: { data : 'project=<?=$project?>', type : 'POST' }
			},
			touch: false,
