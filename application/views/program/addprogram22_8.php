...
<div class="main-section" id="add-floor"> 
    <div class="container">
 <form method="POST" action="<?=base_url();?>program/addprogram" class="register-form_1" id="register-form" enctype="multipart/form-data">
								...
								<table class="table">
									<tbody>
										...
										<tr id="remove<?=$val->id;?>">
											<td><?=$val->file_name;?></td>
											<td><?=$val->file_size;?></td>
											<td><a id="<?=$val->id;?>" onclick="GFG_click(this.id)" >
                        ...
                        <div class="table-content">	  
                            <ul class="nav nav-tabs ">
				                <li class="active"><a data-toggle="tab" href="#menu1">MAIN MENU</a></li>
								 <li><a data-toggle="tab" href="">ASSIGN PROGRAM</a></li>
                            ...
                            <div class="table_info floor-step">
								...
								<p style="color:#00b050!important;font-weight: bold!important;">CURRENTLY SELECTED :<p> PROGRAM (ADD)
...
var url="<?php echo base_url();?>program/addstep1Program"; 
...
$.ajax({  
		...
		{ 
			...
			if (data) {
				$.fancybox.open({
					src: 'http://13.235.169.150/XFactor/program/programCreateSuccess/'+data,
					type: 'ajax',    
					opts: {
