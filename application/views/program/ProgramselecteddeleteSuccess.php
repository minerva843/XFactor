        ...
        <div class="top-header">
            <div class="row">
                <div class="col-md-9"><?php //print_r($zone[0]);  ?>  
                    <h2>PROGRAM (DELETE) <span class="sucess"> SUCCESSFUL </span></h2>
                    <p><b><?php echo date('Ymd hi'); ?>h.</b> ALL SELECTED PROGRAMS HAS BEEN DELETED</p>
                </div>
                <div class="col-md-3">
        ...
        <div class="middle-body register-form zone-sucess">
            <div class="row">
				...
				<div class="row">
					...
					<h5>ALL SELECTED PROGRAMS TO BE DELETED ARE LISTED BELOW : </h5>
					</div>
					</div>
					</div>	
                ...
                <div class="col-md-3 right-text">
                    <div class="tab right-tabs">
						  ...
						  <p><span class="current-bold">CURRENTLY SELECTED :</span> <span style="color:black;font-size: 14px;font-weight: bold;" ><?php if($_SESSION['Singledata'] == 1){
  ...
  x.disabled = true;
		...
		$("body").on('click','#btn555',function(){
           ...
           $.fancybox.open({
			...
			ajax: { 
			   settings: { data : 'project=<?=$_SESSION["SelectedDelete"][0]["project_id"];?>', type : 'POST' }
			},
			touch: false,
					clickSlide: false,
			clickOutside: false
