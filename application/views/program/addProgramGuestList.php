...
<div class="main-section" id="floor-sort"> 
  ...
  <div class="modal-body">
    <h4>PROGRAM (ADD) <span style="color:red">NOT SUCCESSFUL</span></h4>
...
<script type="text/javascript">
 ...
 $("body").on('click','#btn5',function(){
        ...
        autoSize  : true,
        type        : "ajax",
        src         : "<?php echo base_url(); ?>program/addprogram/<?php echo $data1->id;?>",
        ajax: { 
	...
	$.ajax({  
		...
		{ 
			...
			$.fancybox.getInstance('close');
             ...
             $.fancybox.open({
                src: '<?=base_url();?>program/viewAddProgramsSuccessful/'+data,
                type: 'ajax',
                ajax: {
...
$(document).ready(function(){
        ...
        $('body').on('click', '#close-btnprogramstep2', function () {
            ...
            window.location.href = "<?php echo base_url(); ?>program/deleteJunkRecord/<?php echo $data1->id; ?>/<?php echo $data1->group_id; ?>/<?php echo $data1->project_id; ?>/ADD/2";
                    ...
                    <div class="tab right-tabs">
                        ...
                        <div class="table-content">	  
							...
							<li class="active"><a data-toggle="tab" href="#menu1">MAIN MENU</a></li>
                                <li><a data-toggle="tab" href="" class="allassign cnone">ALL ASSIGNMENTS</a></li>
