...
<div class="main-section" id="floor-sort"> 
    <div class="container">
        ...
        <div class="top-header">
            <div class="row">
                ...
                <div class="col-md-3">
                    <div class="top-close"><input type="button" value="CLOSE" class="close-btn" name="submit" id="close-btneditpro2"></div>
                </div>
            </div>   
        </div>	      
                    ...
                    <div class="floor-sec"> 
						<div class="tab-listing">
						  ...
						  <select class="dropdown" id="selectShortBy">
							...
							<div class="floor-table edit_programguest_list">
  ...
  <div class="modal-content">
   <div class="modal-body">
    <h4>PROGRAM (EDIT) <span style="color:red">NOT SUCCESSFUL</span></h4>
...
<script type="text/javascript">
 ...
 $("body").on('click','#btn5',function(){
        ...
        autoSize  : true,
        type        : "ajax",
        src         : "<?php echo base_url(); ?>program/editprogramstep1/<?php echo $data1->id;?>",
        ajax: { 
...
$("#submitbtn").click(function() {
	...
	if(val==''){
		...
		var id="<?=$data1->id;?>";
	var url="<?=base_url();?>program/AddProgramGuest";
	$.ajax({  
		type: "POST",
		url: url, 
		data: {ids:val,id:id},
		...
		{ 
			...
			$.fancybox.getInstance('close');
             ...
             $.fancybox.open({
                src: '<?=base_url();?>program/vieweditProgramsSuccessful/'+data,
                type: 'ajax',
                ajax: {
	...
	function reply_click(clicked_id)
	 {
	  $.ajax({
	   url:"<?=base_url();?>program/ProgramGuestSingleData",
	   method:"GET", 
...
$(document).ready(function(){
        ...
        $('body').on('click', '#close-btneditpro2', function () {
            $.fancybox.close();
            
            
            window.location.href = "<?php echo base_url(); ?>program/deleteJunkRecord/<?php echo $data1->id; ?>/<?php echo $data1->group_id; ?>/<?php echo $data1->project_id; ?>/EDIT/2";
 ...
 function load_data(select_program='',program_shortby='',Allsearch='')
 {
	var id="<?=$data1->id;?>";
  $.ajax({
   url:"<?=base_url();?>program/addProgramSearchList",
   method:"POST", 
   data:{selectData:select_program,AllSearchData:Allsearch,selectShortBy:program_shortby,id:id,project:<?php echo $project_select; ?>},
   success:function(data)
   {
	//console.log(data); 
    $('#AllData').html(data);
                    ...
                    <div class="tab right-tabs">
                        ...
                        <!--         <li><a data-toggle="tab" href="" class="allassign">ALL ASSIGNMENTS</a></li>
                            ...
                            <div class="table_info floor-step">
                                <p> <span class="current-bold">CURRENTLY SELECTED :</span> PROGRAM (EDIT)</p>
								 <h5>STEP 2 OF 2</h5>
								 <p>SELECT PROGRAM PRESENTER(S)</p>
