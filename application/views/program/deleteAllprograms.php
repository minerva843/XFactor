        ...
        <div class="top-header">
            <div class="row">
                <div class="col-md-9"><?php //print_r($zone[0]);  ?>  
                    <h2>PROGRAM (DELETE ALL)</h2>
                    <p style='color:red;'> DELETE ALL MEANS ALL PROGRAMS AND RELATED DATA CANNOT BE RETRIEVED IN FUTURE. </p>
                </div>
                    ...
                    <div class="tab right-tabs">
						  ...
						  <p><span class="current-bold">CURRENTLY SELECTED :</span> <span style="color:black;font-size: 14px;font-weight: bold;" >ALL PROGRAMS</span></p>
							...
							<div class="tab-content sucess-tab-page">
									...
									<p><b>ARE YOU SURE YOU WANT TO <span style="color:red;font-weight: 600 !important;">DELETE <?php if($selected){ echo '</span> THE SELECTED ';}else{ echo 'ALL </span>';}  ?>  PROGRAMS?</b></p>   
                                </div>
						  </div>
						  </div>
						  </div>
...
function myFunction() {
  ...
  x.disabled = true;
        ...
        autoSize  : true,
        type        : "ajax",
        src         : "<?php echo base_url(); ?>program/alldeleteprogram",
        ajax: { 
           settings: { data : 'project=<?=$project?>', type : 'POST' }
        },
        touch: false,
