...
<div class="main-section" id="add-floor"> 
        ...
        <div class="top-header">
            <div class="row">
                <div class="col-md-9"><?php //print_r($zone[0]);  ?>  
                    ...
                    <p> <b><?php echo date('Ymd hi'); ?> .</b> THIS CONTENT SET HAS BEEN EDITED.</p>
                </div>
   ...
   <!--  <div class="row">
        ...
        <!--   <div class="row">
			...
			<div class="col-md-12" id="printJS-form-guest2-edit">
			<div class="row">
				...
				<li class=""><a data-toggle="tab" id="assign_contenteditsuccess" href="#menu1">ASSIGN CONTENT</a></li>
                            ...
                            <div class="table_info floor-step">
                                <!-- <h5>STEP 1 OF 1</h5> -->
                                <p style="color:#00b050!important;font-weight: bold!important;">CURRENTLY SELECTED : <span style="color:black;font-size: 14px;font-weight: bold;" >CONTENT SET (EDIT)</span></p>
