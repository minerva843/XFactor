...
<form action="" method="POST" id="addZoneForm">    
				...
				<div class="select-box assign-zone-select">
					...
					<option disabled="" value="" selected="" > SHOW ALL ZONES</option>
   ...
   echo "</tr>";  
    ...
    ?>
                            ...
                            <div class="form-submit"> 					
                                <input type="button" value="RESET ALL GRIDS TO UNUSED" class="removeall" name="back" id="btn5resetallcontent">
