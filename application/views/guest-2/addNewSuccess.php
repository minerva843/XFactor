        ...
        <div class="top-header">
            <div class="row">
                <div class="col-md-9"><?php //print_r($zone[0]);  ?>  
                    ...
                    <p> <b><?php echo date('Ymd hi'); ?> .</b> THIS CONTENT SET HAS BEEN ADDED.</p>
                </div>
...
<div class="row">
				...
				<li class=""><a data-toggle="tab" id="assign_contentaddsuccess"  href="#menu1">ASSIGN CONTENT</a></li>
                            ...
                            <div class="table_info floor-step">
                                <!-- <h5>STEP 1 OF 1</h5> -->
                                <p style="color:#00b050!important;">CURRENTLY SELECTED : <span style="color:black;font-size: 14px;" >CONTENT SET (ADD)</span></p>
