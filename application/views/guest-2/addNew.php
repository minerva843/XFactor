<div class="main-section" id="add-floor"> 
    <div class="container">
<form action="<?=base_url();?>Content/UploadVideos" method="POST" id="addZone">
                        ...
                        <div class="table-content">	  
                            <ul class="nav nav-tabs ">
				                ...
				                <li class="active"><a data-toggle="tab" href="#menu1">MAIN MENU</a></li>
				                    <li class=""><a  id="assign_contentadd" data-toggle="tab" href="#menu1">ASSIGN contect</a></li>
								
                            </ul>
                            <div class="table_info floor-step">
							<div class="current-status">
								<p class="current-status-1" style="color:#00b050!important;">CURRENTLY SELECTED : <span style="color:black;font-size: 14px;" >CONTENT SET (ADD) </span></p>
