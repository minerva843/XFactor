...
<div class="main-section"> 
    <div class="container">
        ...
        <div class="top-header">
            <div class="row">
                <div class="col-md-9">
                    <h2>WHAT'S HOT (<?php echo $action;?>) </h2>
                   <p style="color:red">REMOVE MEANS ALL SELECTED WHAT'S HOT AND RELATED DATA CANNOT BE RETRIEVED IN FUTURE.
        ...
        <div class="middle-body register-form zone-sucess content-delete-single">
            <div class="row">
				...
				<div class="leftbox-top">
					<h5> ALL SELECTED WHAT'S HOT TO BE REMOVE ARE LISTED BELOW : </h5>
					</div>  
                        ...
                        <div class="table-content">	  
							...
							if(count($data)>1){ echo "MULTIPLE WHAT'S HOT"; }else{ echo $data[0]->whatshot_title; }
                                ...
                                <div class="tab-content sucess-tab-page">
									<p><b>TO CHECK AGAIN BEFORE <span style="color:red;font-weight: 600 !important;"> REMOVE <?php if($selected){ }else{echo 'ALL';} ?></span> , CLICK BACK.</b></p><br/>
									<p><b>ARE YOU SURE YOU WANT TO <span style="color:red;font-weight: 600 !important;">REMOVE <?php if($selected){ echo '</span> THE SELECTED ';}else{ echo 'ALL </span>';}  ?>  WHAT'S HOT?</b></p>   
                                </div>
                            </div>
							
                            <div class="form-submit"> 
                                <a class="action-btn" id="btn5" >Back</a>
                                <input type="button" value="<?php if($selected){echo 'REMOVE';}else{echo 'DELETE ALL';} ?>" class="action-btn" name="submit" id="submitbtndelete">
                            </div>
                        </div>
                    </div>
                </div>
...
var strids="<?php print($ids);?>";
 ...
 // console.log(strids);     
       $.fancybox.open({
        ...
        autoSize  : true, 
        type        : "ajax",
        src         : "<?php echo base_url(); ?>whats_hot/removeSlotsSuccess",
        ajax: { 
