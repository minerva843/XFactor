...
<div class="main-section poject-listing-QT" id="floor-sort"> 
                                ...
                                <script>
                                    $(document).ready(function () {
                                       ...
                                       $("#PosteditProject").click(function () {
											//alert("edit");
											currentid="";
											$("#ViewSingleData").empty().html("<p><span class='current-bold'>CURRENTLY SELECTED : </span> NO WHAT'S HOT SELECTED</p>");
                                            ...
                                            if($(this).hasClass('activebtn')){
											    ...
											    ///  $(".chk2").css("display","none");
											      $("#ViewSingleData").find("#multipleprojectselect").text("NO WHAT'S HOT SELECTED");
												   $("#ViewSingleData").empty().html("<p><span class='current-bold'>CURRENTLY SELECTED : </span> NO WHAT'S HOT SELECTED</p><p><span class='current-bold'>CURRENTLY VIEWING : </span> NO WHAT'S HOT SELECTED</p>");
	...
	// $trs.filter("#AllData tr:even").css("background-color", "#d9d9d9");
                                ...
                                <script type="text/javascript">
                                    ...
                                    $("#Postsubmitbtn12").click(function () {
                                        ...
                                        //if($("#PosteditProject").hasClass('activebtn')){
                                            ...
                                            $.fancybox.getInstance('close');
											 ...
											 $.fancybox.open({
												...
												autoSize  : true,
												type        : "ajax",
												src         : "<?php echo base_url(); ?>whats_hot/assignremove/" + currentid,
												ajax: { 
												   settings: { data : 'whatid='+currentid+'&ids=<?=$ids;?>&action=<?=$action?>', type : 'POST' }
												},
												touch: false,
														clickSlide: false,
												clickOutside: false
	...
	// }
					...
					// }else {
						...
						//alert();
                                        ...
                                        $('#d_' + currentid).prop('checked', true);
...
//                                    });
					...
					$("#PosteditProject").removeClass("activebtn");
					    ...
					    var Allsearch=$('.SER').val();
                                        ...
                                        function load_data(selectData = '', selectShortBy = '',Allsearch='')
                                        {
                                            ...
                                            $.ajax({
                                                url: "<?= base_url(); ?>whats_hot/assignsearch",
                                                method: "POST",
                ...
                <div class="col-md-3 right-text master-floor-left all_post_slider whats-hot-right">
                        ...
                        <div class="table-content">	  
                            <ul class="nav nav-tabs ">
                                <!--li><a data-toggle="tab" href="#home">CONFIG PAGE</a></li-->
                                 ...
                                 <li><a data-toggle="tab" href="" id="index1">MAIN MENU</a></li>
								
								 <li class="active"><a data-toggle="tab" href="" id="posticon_assignment">ASSIGN ENTRIES</a></li>
                            ...
                            <div class="form-submit delete-sorting" <?php echo $showbtn; ?> > 
                                ...
                                <input type="button" value="Next" class="action-btn form-submit-btn" name="submit" id="Postsubmitbtn12">
                            </div>
                        </div>
                    </div>
                </div>
