...
<div class="main-section"> 
    <div class="container">
        ...
        <div class="top-header">
            <div class="row">
                <div class="col-md-9">
                    <h2>WHAT'S HOT (DELETE<?php if($selected){ }else{echo ' ALL';} ?>) <span class="sucess" style="color: #00b050;" >SUCCESSFUL</span> </h2>
                   <p><b><?php echo date('Ymd hi'); ?>h.</b> <?php if($selected){ echo 'ALL SELECTED'; }else{echo 'ALL';} ?> WHAT'S HOT HAVE BEEN DELETED.</p>
                </div>
