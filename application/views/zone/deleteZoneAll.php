        ...
        <div class="top-header">
            <div class="row">
                <div class="col-md-9"><?php //print_r($zone[0]);  ?>  
                    <h2>ZONES (DELETE ALL) </h2>
                   <p style="color:red">DELETE ALL MEANS ALL ZONES AND RELATED DATA CANNOT BE RETRIEVED IN FUTURE.</p>
                </div>
        ...
        <div class="middle-body register-form zone-sucess">
            <div class="row">
				...
				<div class="leftbox-top">
					<h5> ALL ZONES TO BE DELETED ARE LISTED BELOW :</h5>
					</div>  
					...
					<div class="col-md-9">
                        ...
                        <form>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-8">
                                    <div class="zone-label"><?=$data['zone']['project_xid']?></div>
                                </div>
                            </div>
			...
			<div class="form-group row">
				...
				<li class="active"><a data-toggle="tab" href="#menu1">MAIN MENU</a></li>
                            ...
                            <div class="table_info floor-step">
                                ...
                                <p><span class="current-bold">CURRENTLY SELECTED :</span> <span style="color:black;font-size: 14px;" >ALL ZONES</span></p>
								<br>
								...
								<p><b>TO CHECK AGAIN BEFORE <span style="color:red; font-weight: 600 !important;">DELETE ALL</span>, CLICK BACK.</b></p><br/>
						    <p><b>ARE YOU SURE YOU WANT TO <span style="color:red; font-weight: 600 !important;">DELETE ALL</span> ZONES?</b></p>
                                </div>
                            </div>

                            <div class="form-submit"> 
                                <a class="action-btn" id="btn5deleteallzone" >Back</a>
                                <input type="submit" value="DELETE ALL" class="action-btn" name="submit" id="btn555delezoneall">
                            </div>
                        </div>
                    </div>
                </div>
...
function myFunction() {
  ...
  x.disabled = true;
      ...
      $.fancybox.open({
        ...
        $("body").on('click','#btn555delezoneall',function(){
      ...
      $.fancybox.open({
        ...
        autoSize  : true,
        type        : "ajax",
        src         : "<?=base_url();?>zone/deleteAllZoneSuccess",
        ajax: { 
           settings: { data : 'project=<?php echo $project_select; ?>', type : 'POST' }
        },
        touch: false,
