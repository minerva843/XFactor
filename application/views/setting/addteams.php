...
<form action="<?php echo base_url(); ?>" method="POST" id="addTerms">
        ...
        <div class="middle-body register-form" >
			...
			<div class="col-md-9">
			<h5> <b>ALL DETAILS OF TERMS OF USE ARE LISTED BELOW. </b></h5> 
			</div>
			...
			<textarea rows="20" cols="50" maxlength="" id="terms_of_use" class="terms_of_use" name="terms_of_use" placeholder="ENTER POST DETAILS" value="
			<?php echo $data1->terms_of_use;?>"><?php echo $data1->terms_of_use;?>
			</textarea>
							<script>
                    ...
                    <div class="tab right-tabs">
                        ...
                        <div class="table-content">	  
                            <ul class="nav nav-tabs ">
                             ...
                             <div class="table_info floor-step setting_ui">                                
							  ...
							  <li><a class="current">LEGAL</a> </li>
								<li><a class="teams_of_use active">TERMS OF USE</a> </li>
                            ...
                            <div class="form-submit"> 
                               ...
                               <a class="action-btn" id="submitbtncontentterms" >Next</a>
...
$("#addTerms").submit(function(e) {
    ...
    submitHandler: function(form) { 
        ...
        var terms_of_use=CKEDITOR.instances.terms_of_use.getData();
 ...
 formdata.append('terms_of_use', terms_of_use);
   ...
   $.ajax({
     ...
     url: '<?php echo base_url(); ?>setting/addterms_post', 
     type: 'post',
     data: formdata,
    dataType: 'html',
     contentType: false,
     ...
     success: function (response) {
			...
			if (data) {
				$.fancybox.open({
					src: '<?php echo base_url(); ?>setting/addterms_success/'+data,
					type: 'ajax',    
					opts: {
