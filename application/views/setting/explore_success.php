...
<form action="<?php echo base_url(); ?>" method="POST" id="addLOGO">
        ...
        <div class="middle-body register-form" >
			...
			<div class="col-md-12">
			<h2>HEADER LET'S EXPLORE PAGE </h2>
			</div>
			</div>
				   		
			<div class="row setting-top">
			<div class="col-md-7">
			<h3> <?php echo date('Ymd hi'); ?>h. HEADER LET'S EXPLORE PAGE (EDIT) <b><span class="sucess">SUCCESSFUL </span></b></h3> 
			</div>
			...
			<div class="table-cont setting_body"> 
						<p> <b>ALL DETAILS OF HEADER LET'S EXPLORE PAGE ARE LISTED BELOW. </b></p> 

			<div class="setting_logo">  
			
			<?=$data1->header_lets_explore_title;?>
