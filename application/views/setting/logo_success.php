...
<form action="<?php echo base_url(); ?>" method="POST" id="addLOGO">
        ...
        <div class="middle-body register-form" >
            <div class="row">
			 ...
			 <div class="col-md-9" id="printJS-form-logo">  <?php // print_r($zone); ?>
			...
			<div class="col-md-7">
			<h3> <?php echo date('Ymd hi'); ?>h. LOGO TOP LEFT (EDIT) <b><span class="sucess">SUCCESSFUL </span></b></h3> 
			</div>
			
			<div class="col-md-5 text-right">
			<a href="#" class="setting_edt_btn" onclick="printJS({printable:'printJS-form-logo', type:'html',targetStyles: ['*']})">PRINT</a> 
			<a href="#" class="setting_edt_btn logo_done">DONE</a>  
			</div>    			
			</div>	 
			
			<div class="table-cont setting_body"> 
						<p> <b>ALL CHANGES HAVE BEEN SAVED. CURRENT IMAGE THAT IS USED IS DISPLAYED BELOW. </b></p> 
                        ...
                        <div class="table-content">	  
                            ...
                            <div class="table_info floor-step setting_ui">                                
                              <ul>
								...
								<li><a class="">HEADER, HOME PAGE, SHOW / HIDE</a></li>
								<li> <a class="">HEADER, LET'S EXPLORE PAGE</a></li>
								</ul>
...
<script>
$("body").on('click','.logo_done',function(){
