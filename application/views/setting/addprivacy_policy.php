...
<form action="<?php echo base_url(); ?>" method="POST" id="addTerms">
        ...
        <div class="middle-body register-form" >
			...
			<div class="col-md-9">
			<h5> <b>ALL DETAILS OF PRIVACY POLICY ARE LISTED BELOW. </b></h5> 
			</div>
			...
			<div class="table-cont setting_body post_textarea poject_editor"> 
			<textarea rows="10" cols="50" maxlength="" id="privacy_policy" class="privacy_policy" name="privacy_policy" placeholder="ENTER POST DETAILS" value="
			<?php echo $data1->privacy_policy;?>"><?php echo $data1->privacy_policy;?>
			</textarea>
							<script>
                            ...
                            <ul class="nav nav-tabs ">
                             ...
                             <div class="table_info floor-step setting_ui">                                
							  ...
							  <li><a class="current">LEGAL</a> </li>
								...
								<li><a class="privacy_policy active">PRIVACY POLICY</a></li>
...
$("#addTerms").submit(function(e) {
 ...
 formdata.append('privacy_policy', privacy_policy);
   ...
   $.ajax({
     ...
     url: '<?php echo base_url(); ?>setting/addprivacy_policy_post', 
     type: 'post',
     data: formdata,
    dataType: 'html',
     contentType: false,
     ...
     success: function (response) {
			...
			if (data) {
				$.fancybox.open({
					src: '<?php echo base_url(); ?>setting/privacy_policy_success/'+data,
					type: 'ajax',    
					opts: {
