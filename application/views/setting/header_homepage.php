...
<form action="<?php echo base_url(); ?>" method="POST" id="addZone">
        ...
        <div class="middle-body register-form" >
			...
			<a href="#" class="setting_edt_btn default_logo12">USE DEFAULT SETTINGS</a> 
...
<script>
$("body").on('click','.default_logo12',function(){
	var formdata='';
      $.ajax({
...
$("body").on('click','.addlogo',function(){
   ...
   $.fancybox.getInstance('close');
	$.fancybox.open({
        ...
        autoSize  : true,
        type        : "ajax",
        src         : "<?php echo base_url(); ?>setting/addheader_homepage",
        ajax: { 
           settings: { data : 'project=<?=$project_id?>', type : 'POST' }
        },
        touch: false,
