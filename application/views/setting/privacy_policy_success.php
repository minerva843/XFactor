...
<form action="<?php echo base_url(); ?>" method="POST" id="addLOGO">
		...
		<!--		<link rel="stylesheet" href="<?=base_url();?>assets/css/style.css" type="text/css"> -->
			...
			<div class="col-md-7">
			<h3> <?php echo date('Ymd hi'); ?>h. PRIVACY POLICY (EDIT) <b><span class="sucess">SUCCESSFUL </span></b></h3> 
			</div>
			...
			<div class="table-cont setting_body"> 
						<p> <b>ALL DETAILS OF PRIVACY POLICY ARE LISTED BELOW. </b></p> 

			<div class="setting_logo">  
			
			<?=$data1->privacy_policy;?>
