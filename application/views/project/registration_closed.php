...
<div class="col-md-4">    
		...
		<?php }?>
				...
				<h2 class="regi-normal">REGISTRATION HAS CLOSED. </h2>   
				
				<!--div class="register-success notregister-success">
				<p>YOUR REGISTRATION IS  <span class="not-sucess"><b>NOT SUCCESSFUL.</b></span></p>
				<p>CLICK ON THE LINK BELOW TO RETURN TO RETRY.</p>
				<p><a href=""> REGISTRATION PAGE </a> </p>  
				
				<h3>FOR ASSISTANCE</h3>
				<p>SHOULD YOU REQUIRE FURTHER ASSISTANCE, WE CAN BE CONTACTED AT <span class="mail-to"><a href="mailto:webmaster@example.com">support@xplatform.live </a> </span></p>
				</div-->  
