...
<div class="main-section fancybox-content" id="add-floor" style=""> 
    <div class="container">
        ...
        <div class="top-header">
            <div class="row">
                <div class="col-md-9">  
                    <h2 class="project-msg">PROJECTS & REGISTRATION FORMS (ADD) <span class="sucess">SUCCESSFUL </span></h2>
                    <p> <b class="loweditbt"><?php echo date('Ymd hi'); ?>h.</b> THIS PROJECT HAS BEEN ADDED.</p>
                </div>
        ...
        <div class="middle-body register-form zone-sucess success_msg_display"> 
            <div class="row">
				...
				<div class="row">
					...
					<h5> ALL PROJECT DETAILS ARE LISTED BELOW :</h5>
					</div>
					</div>
					<div class="row">
	            ...
	            <div class="leftbox-top">
					...
					<div class="col-md-12" id="printJS-form-project-add"> 
   ...
   text: '<?=$data1->checkin_page_url?>' 
				...
				<li class="active"><a data-toggle="tab" href="#menu1">MAIN MENU</a></li>
                            ...
                            <div class="table_info floor-step">
                                <p> <span class="current-bold">CURRENTLY SELECTED :</span> <span style="color:black;font-size: 14px;"><?=$data1->project_name;?></span></p>
                            ...
                            <div class="form-submit"> 
                                <input type="button" value="PRINT" class="action-btn" onclick="printJS({printable:'printJS-form-project-add', type:'html',targetStyles: ['*']})" id="submitSuccback">
