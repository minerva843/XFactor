...
<?php session_start();?>
        <div class="top-header">
            <div class="row">
                <div class="col-md-9">  
                    <h2>PROJECTS & REGISTRATION FORMS (DELETE)</h2>
                    <p style='color:red;'> DELETE MEANS ALL SELECTED PROJECTS AND RELATED DATA CANNOT BE RETRIEVED IN FUTURE. </p>
                </div>
        ...
        <div class="middle-body register-form zone-sucess_multi">
            <div class="row">
                <div class="col-md-9">
...
<!--                                 <a class="nav-item nav-link" id="nav-contact-tab" data-toggle="tab" href="#nav-contact" role="tab" aria-controls="nav-contact" aria-selected="false">Project Tab 3</a> -->
                            ...
                            <div class="table_info floor-step">
                                <p style="color:#00b050!important;"> <span class="current-bold">CURRENTLY SELECTED :</span> <span style="color:black;font-size: 14px;">
                                ...
                                <div class="tab-content sucess-tab-page">
                                    ...
                                    <p><b>TO CHECK AGAIN BEFORE <span style="color:red;font-weight:bold !important;">DELETE</span>, CLICK BACK.</b></p> <br>
						    <p><b>ARE YOU SURE YOU WANT TO <span style="color:red;font-weight:bold !important;">DELETE </span> THE SELECTED PROJECTS?</b></p>
  ...
  x.disabled = true;
		...
		$("body").on('click','#btn555',function(){
         ...
         $.fancybox.open({
				...
				autoSize  : true,
				type        : "ajax",
				src         : "<?=base_url();?>project/ProjectselecteddeleteSuccess",
				ajax: { 
				   settings: { data : 'group_id=<?php echo $group_id; ?>', type : 'POST' }
				},
				touch: false,
