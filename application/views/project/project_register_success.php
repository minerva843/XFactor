...
.create-user select#year {
	...
	<div class="section-main">   		        
	    ...
	    <li> <a href="#">XCONNECT (LET’S EXPLORE)</a> </li>
               ...
               <div class="register-header"><?php if(!empty($data->register_header_image!=='NIL')){?>
		<img src="<?php echo base_url();?>assets/project/<?=$data->register_header_image;?>">
		<?php }else{?>
		<!--h2>SIMPLY FILL IN YOUR DETAILS TO REGISTER. </h2--> 
		<?php }?>
		</div>
                <div class="signup-form create-user">
				<h2 class="regi-normal">REGISTRATION FORM FOR <b><?php echo $data->project_name?></b> </h2>
				...
				<p>YOUR ACCOUNT DETAILS CAN BE FOUND IN THE "REGISTRATION SUCCESSFUL" EMAIL.</p>
