...
<form method="POST" action="<?=base_url();?>project/addstep3project/<?=$data1->id;?>" class="register-form" id="registerform420" enctype="multipart/form-data">
        <div class="top-header">
            <div class="row">
                ...
                <div class="col-md-3">
                    <div class="top-close"><input type="type" value="CLOSE" class="close-btn"  id="close-btn5"></div>
                </div>
            </div>   
        </div>	   
...
$.ajax({  
		...
		$.fancybox.getInstance('close');
			...
			if (data) {
						...
						autoSize  : true,
						type        : "ajax",
						src         : "<?=base_url();?>project/addstep4/"+data,
						ajax: { 
		...
		$("body").on('click','.backbtn',function(){
           ...
           $.fancybox.getInstance('close');
            $.fancybox.open({
				...
				autoSize  : true,
				type        : "ajax",
				src         : "<?=base_url();?>project/addstep2project/<?=$data1->id;?>",
				ajax: { 
				   settings: { data : 'group_id=<?php echo $data1->group_id; ?>', type : 'POST' }
				},
				touch: false,
...
$('body').on('click', '#close-btn5', function () {
