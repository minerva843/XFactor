...
<div class="main-section fancybox-content" id="add-floor" style=""> 
    <div class="container">
        ...
        <div class="top-header">
            <div class="row">
                <div class="col-md-9">  
                    <h2>PROJECTS & REGISTRATION FORMS (DELETE) <span class="sucess">SUCCESSFUL </span></h2>
                    <p> <b class="loweditbt"><?php echo date('Ymd hi'); ?>h.</b> ALL SELECTED PROJECTS HAVE BEEN DELETED.</p>
                </div>
        ...
        <div class="middle-body register-form zone-sucess_ZST">
            <div class="row">
                <div class="col-md-9">
	            ...
	            <div class="leftbox-top">
					<h5> ALL SELECTED PROJECTS THAT ARE DELETED ARE LISTED BELOW :</h5>
					</div> 
					</div>
					</div>	
		...
		<div class="col-md-12" id="printJS-form-project-deleteselected">
				<link rel="stylesheet" href="<?=base_url();?>assets/css/print.css" type="text/css">
                    
               <?php foreach($_SESSION['SelectedDelete'] as $data1){ ?>
                       ...
                       <form>
						...
						?>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-8">
                                    <div class="zone-label loweditbt"><?php if(isset($data1->last_edited_date_time)){ echo $data1->last_edited_date_time .'h';}else{ echo "NIL"; }?></div>
                                </div>
                            </div>
                       ...
                       <div class="col-md-9">
                        ...
                        <form>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-8">
                                    <div class="zone-label"><a><?php echo $data1->checkin_page_url;?></a></div>
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-8">
                                    <div class="zone-label"><a><?=$data1->register_header_image?> </a></div>
                                </div>
                            </div>
...
<!--                                 <a class="nav-item nav-link" id="nav-contact-tab" data-toggle="tab" href="#nav-contact" role="tab" aria-controls="nav-contact" aria-selected="false">Project Tab 3</a> -->
                            ...
                            <div class="table_info floor-step">
                                <p style="color:#00b050!important;">CURRENTLY SELECTED : <span style="color:black;font-size: 14px;">
								<?php if($_SESSION['Singledata'] == 1){
									echo $_SESSION['SelectedDelete'][0]->project_name;
								}else{
                            ...
                            <div class="form-submit"> 
                                <input type="button" value="PRINT" class="action-btn" onclick="printJS({printable:'printJS-form-project-deleteselected', type:'html',targetStyles: ['*']})" id="submitSuccback">
