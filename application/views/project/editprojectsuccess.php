...
<div class="main-section fancybox-content" id="add-floor" style=""> 
    <div class="container">
        ...
        <div class="top-header">
            <div class="row">
                <div class="col-md-9">  
                    <h2 class="project-msg">PROJECTS & REGISTRATION FORMS (EDIT) <span class="sucess">SUCCESSFUL </span></h2>
                    <p> <b class="loweditbt"><?php echo date('Ymd hi'); ?>h .</b>  THIS PROJECT HAS BEEN EDITED.</p>
                </div>
        ...
        <div class="middle-body register-form zone-sucess success_msg_display"> 
            <div class="row">
	            ...
	            <div class="leftbox-top">
					...
					<div class="col-md-12" id="printJS-form-project-edit">
                       ...
                       <h3> PROJECT CREATION INFO </h3>  				
                        <form>
                            <div class="form-group row">
                                <label for="colFormLabelSm" class="col-sm-4 col-form-label col-form-label-sm" style="flex: 0 0 33.333333%;max-width: 33.333333%;">GROUP</label>
                                <div class="col-sm-8" style="flex: 0 0 66.666667%;max-width: 66.666667%;">
...
$('.qr1').ClassyQR({
   ...
   text: '<?=$data1->checkin_page_url?>' 
							...
							<div class="form-group row">
                                ...
                                <div class="col-sm-8">
                                    <div class="zone-label"><div class="qrcode qr1"></div></div>
                                </div>   
                            </div>  
							<?php }?>
...
<!--                                 <a class="nav-item nav-link" id="nav-contact-tab" data-toggle="tab" href="#nav-contact" role="tab" aria-controls="nav-contact" aria-selected="false">Project Tab 3</a> -->
                            ...
                            <div class="table_info floor-step">
                                <p style="color:#00b050!important;"> <span class="current-bold">CURRENTLY SELECTED :</span> <span style="color:black;font-size: 14px;"><?=$data1->project_name;?></span></p>
                            ...
                            <div class="form-submit"> 
                                <input type="button" value="PRINT" class="action-btn" onclick="printJS({printable:'printJS-form-project-edit', type:'html',targetStyles: ['flex','max-width']})" id="submitSuccback">
