        ...
        <div class="middle-body register-form zone-sucess">
            <div class="row">
	            ...
	            <div class="leftbox-top">
		            ...
		            <div class="col-md-12" id="printJS-form-group-add">   
                    ...
                    <div class="tab right-tabs">
                        ...
                        <div class="table-content">	  
                            ...
                            <div class="form-submit"> 
                               <input type="button" value="PRINT" class="action-btn" onclick="printJS({printable:'printJS-form-group-add', type:'html',targetStyles: ['*']})" id="submitSuccback">
