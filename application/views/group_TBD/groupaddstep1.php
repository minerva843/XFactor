        ...
        <div class="middle-body register-form">
            ...
            <div class="row">
				   ...
				   <div class="row">
					...
					<h3> GUEST PERSONAL INFO  <?php //echo $project_select; ?> <?php //echo $group_id; ?></h3>  
					</div>
					</div>	
				   ...
				   <div class="zone-info floor-planadd add-project-step2 guest_add">				
						...
						<div class="form-group row">
							...
							<div class="col-sm-5">
								...
								<option value="<?php echo $guesttype; ?>" <?php if( isset($data1->guest_type) && $data1->guest_type==$guesttype){echo 'selected';} ?> ><?php echo $guesttype; ?></option>
								...
								<span class="register-hint">GUEST TYPE CANNOT BE CHANGED AFTER A GUEST IS ADDED. </span>
						...
						<div class="form-group row">
							...
							<div class="col-sm-6">
								...
								<select name="gender" id="gender">
                                        ...
                                        <option value="Male" <?php if($data1->gender=='Male' || $data1->gender=='MALE'){echo 'selected';} ?> >MALE </option>
                                        <option value="Female" <?php if($data1->gender=='Female' || $data1->gender=='FEMALE'){echo 'selected';} ?> >FEMALE</option>
                                        <option value="COMPANY" <?php if($data1->gender=='COMPANY' || $data1->gender=='Company'){echo 'selected';} ?> >COMPANY</option>
                                    </select>
                                  
                                    <span class="select-icon"><i class="zmdi zmdi-chevron-down"></i></span>
									<span class="register-hint">GENDER CANNOT BE CHANGED AFTER A GUEST IS ADDED</span>
						...
						<div class="form-group row">
							...
							<div class="col-sm-5">
								<input type="email" maxlength="50"  value="<?php echo $data1->email; ?>"  name="email" class="small-case" placeholder="ENTER EMAIL ADDRESS" id="email"  <?php if(!empty($data1->email)){ echo 'readonly';}  ?>    />
	...
	<div class="form-group row">
						...
						<div class="form-group row">
							...
							<div class="col-sm-5">
								...
								<input type="text" value="<?php echo $data1->username; ?>" maxlength="50" name="username" placeholder="ENTER PREFERED NAME TO DISPLAY" id="username"  <?php if(!empty($data1->username)){ echo 'readonly';}  ?>  >
	...
	toolbar: [
                        ...
                        <div class="table-content">	  
                            <ul class="nav nav-tabs ">
				              ...
				              <li><a data-toggle="tab" class="active" href="#menu1">MAIN MENU</a></li>
								<li class=""><a id=guestlistupload1" data-toggle="tab" href="#menu1">GUEST LISTS</a></li>
                            ...
                            <div class="table_info floor-step">
								...
								<p class="current-status-1" style="color:#00b050!important;font-weight: bold!important;">CURRENTLY SELECTED :<p> <?php if(!empty($data1->first_name)){echo $data1->first_name;}else{echo 'GUEST (ADD)';}   ?>
                                </div>
        ...
        <div class="footer">2019 – <?php echo date('Y'); ?> .<b>XPLATFORM</b>. </div>  
					...
					<div class="modal-body">
                                        <h4> GUEST (ADD) <span style="color:red ;font-weight:bold;">NOT SUCCESSFUL </span></h4>
...
var url="<?php echo base_url();?>guest/addstep1Post/<?php if(!empty($data1)){ echo $data1->id; }?>"; 
...
$.ajax({  
      ...
      $.fancybox.open({
        ...
        autoSize  : true,
        type        : "ajax",
        src         : '<?=base_url();?>guest/addstep2',
        ajax: { 
           settings: { data : 'id='+data2.gid+'&project=<?php echo $project_select; ?>&group_id=<?php echo $group_id; ?>&action=<?php echo $action; ?>', type : 'POST' }
        },
        touch: false,
	clickSlide: false,
        clickOutside: false
