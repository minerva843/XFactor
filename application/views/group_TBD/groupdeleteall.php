...
#01-828 BUILDING ABC </div>
				...
				<li class=""><a data-toggle="tab" href="#menu1">GUEST LIST</a></li>
                            ...
                            <div class="table_info floor-step">
                                <p style="color:#00b050!important;">CURRENTLY SELECTED : <span style="color:black;font-size: 14px;font-weight: bold;"><?php if($selected){ echo 'MULTIPLE';}else{ echo 'ALL';}  ?> GUESTS</span></p>
