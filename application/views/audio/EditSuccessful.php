...
<div class="main-section fancybox-content" id="add-floor" style=""> 
    <div class="container">
        ...
        <div class="top-header">
            <div class="row">
                <div class="col-md-9">  
                    <h2>AUDIO STREAM (EDIT) <span class="sucess">SUCCESSFUL </span></h2>
                    <p> <b><?php echo date('Ymd hi'); ?>h.</b>  THIS AUDIO STREAM HAS BEEN EDITED.</p>
                </div>
        ...
        <div class="middle-body register-form zone-sucess"> 
            <div class="row">
                <div class="col-md-9">
					...
					<h5>ALL AUDIO STREAM DETAILS ARE LISTED BELOW :</h5>
					</div> 
					</div>
					</div>	
					...
					<div class="col-md-12" id="printJS-form-audio-edit">
				...
				<li class="active"><a data-toggle="tab" href="#menu1">MAIN MENU</a></li>
                            ...
                            <div class="table_info floor-step">
                                <p style="color:#00b050!important;"><span class="current-bold">CURRENTLY SELECTED :</span> <span style="color:black;font-size: 14px;"><?=$data1->audio_stream_name;?></span></p>
                            ...
                            <div class="form-submit"> 
                                <input type="button" value="PRINT" class="action-btn" onclick="printJS({printable:'printJS-form-audio-edit', type:'html',targetStyles: ['*']})" id="submitSuccback">
