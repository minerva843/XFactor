...
<div class="main-section"> 
    <div class="container">
        ...
        <div class="top-header">
            <div class="row">
                <div class="col-md-9">
                    <h2>AUDIO STREAM (DELETE<?php if($selected){ }else{echo ' ALL';} ?>) </h2>
                   <p style="color:red">DELETE<?php if($selected){ }else{echo ' ALL';} ?> MEANS <?php if($selected){ echo 'ALL SELECTED'; }else{echo 'ALL';} ?> AUDIO STREAMS AND RELATED DATA CANNOT BE RETRIEVED IN FUTURE.
        ...
        <div class="middle-body register-form zone-sucess content-delete-single">
            <div class="row">
				...
				<div class="leftbox-top">
					<h5> <?php if($selected){ echo 'ALL SELECTED'; }else{echo 'ALL';} ?> AUDIO STREAMS TO BE DELETED ARE LISTED BELOW : </h5>
					</div>  
				...
				<li class="active"><a data-toggle="tab" href="#menu1">MAIN MENU</a></li>
                            ...
                            <div class="table_info floor-step">
                                ...
                                <div class="tab-content sucess-tab-page">
									<p><b>TO CHECK AGAIN BEFORE <span style="color:red;font-weight: bold !important;"> DELETE  <?php if($selected){ }else{echo 'ALL';} ?></span>, CLICK BACK.</b></p><br/>
									<p><b>ARE YOU SURE YOU WANT TO <span style="color:red;font-weight: bold !important;">DELETE <?php if($selected){echo '</span> THE SELECTED';}else{echo 'ALL </span>';} ?> AUDIO STREAMS?</b></p>
                                </div>
                            </div>
...
var strids="<?php print($ids);?>";
 ...
 // console.log(strids);     
       $.fancybox.open({
        ...
        autoSize  : true, 
        type        : "ajax",
        src         : "<?php echo base_url(); ?>audio/deleteSelectedSuccess",
        ajax: { 
