...
<div id="containment-wrapper">
    ...
    <div id="<?php echo $icon->id; ?>"   class="draggable ui-widget-content "  style="color:white;background:red;border-radius:50%;right: auto;bottom: auto;position:relative;top:<?php echo $drag->top;?>;left:<?php echo $drag->left;?>;" >
