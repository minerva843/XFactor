...
<div id="containment-wrapper">
    ...
    <div id="<?php echo $icon->id; ?>"   class="draggable ui-widget-content "  style="background:red;border-radius:50%;right: auto;bottom: auto;position:relative;top:<?php echo $drag->draggable3->top;?>px;left:<?php echo $drag->draggable3->left;?>px;" >
        <?php echo $icon->id; ?>
    </div>
    <?php }  ?>
