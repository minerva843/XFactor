<div class="virtual_view avatar simple_view_outer">
		...
		<div class="tabbable tabs-below">
				...
				<div class="row mb-20">
				<div class="col-md-7"> <h3> COMPANY INFO (EDIT) <span class="nosuccess">NOT SUCCESSFUL</span> </h3>   </div>
               <div class="col-md-5 text-right"> 
			    <a href="#" class="xme_btn"> PRINT </a> 
				<a href="<?=base_url();?>xme/my_details_nosuccess" class="xme_btn">RETRY</a>     </div>    
				</div>
				
				<p class="mt20"><b>YYYYMMDD HHMM.</b> COMPANY INFO HAS NOT BEEN EDITED. PLEASE TRY AGAIN.</p>
				<p class="mt20"><b>ALL COMPANY DETAILS ARE LISTED BELOW :</b></p>
				...
				<div class="col-sm-8">
				<div class="zone-label">NEW VALUE COUNTRY NEW VALUE POSTAL CODE</div>
				</div>
				</div>
