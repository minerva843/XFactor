		...
		<div class="tabbable tabs-below">
				...
				<div class="row">				
                 <div class="col-md-12 text-right">  				 
				  <a href="#" class="xme_btn" onclick="printJS({printable:'printJS-form-contact', type:'html',targetStyles: ['*']})" id="submitSuccback"> PRINT </a>   
				...
				<div class="sml-container" id="printJS-form-contact"> 
				<link rel="stylesheet" href="<?=base_url();?>assets/css/print.css" type="text/css">
				<div class="row mb-20">   
				<div class="col-md-12"> <h3> CONTACT  INFO <span class="success">SUCCESSFUL </span> </h3>   </div>
				...
				<div class="col-sm-8">
				<div class="zone-label"><?php if(!empty($user->qrcode)){ echo '<img src="'.base_url().'assets/qrphp/temp/'.$user->qrcode.'">'; }else{ echo 'NIL';}?></div>
				</div>
				</div>
