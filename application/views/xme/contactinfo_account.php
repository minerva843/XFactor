...
<div class="simle_view_midde xme_top">	
				<div class="sml-container">
				    
                <div class="row mb-20">
				<div class="col-md-7"> <h3> DEACTIVATE ACCOUNT </h3>  </div>
                <div class="col-md-5"> <a href="" class="xme_btn"> BACK</a> <a href="<?=base_url();?>xme/contactinfo_account_nosuccess" class="xme_btn"> NEXT</a>  </div>  
				</div>
				...
				<p> A One Time Password has been sent to your email account.</p>				
				           ...
				           <div class="form-group row" style="margin-left:0px;">
                                ...
                                <div class="col-sm-8">
                                    <input type="password" id="identity" name="identity" placeholder="ENTER ONE TIME PASSWORD">
                                </div>
                            </div> 
							...
							<div class="form-group row">  
							<div class="col-sm-6">
							<a href="http://13.235.169.150/XFactor/xme/changenewpassword" class="forgot-xme">RESEND ONE TIME PASSWORD</a>
							</div>
                            </div>
