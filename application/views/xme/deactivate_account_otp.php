...
<div class="simle_view_midde xme_top xme-change-pass">	
				...
				<div class="sml-container">  	
			<form method="POST" action="<?=base_url();?>xme/deactivate_account_success" class="register-form" id="register-form" enctype="multipart/form-data">
                <div class="row">
				...
				<p>A One Time Password has been sent to your email account.</p>
				           ...
				           <div class="form-group row" style="margin-left:0px;">
							...
							<div class="col-sm-6">
							<a href="<?=base_url();?>xme/deactivate_account_otp" class="forgot-xme">RESEND ONE TIME PASSWORD</a>
							</div>
                            </div>
