...
<form method="POST" action="<?=base_url();?>xme/changepassword_success" class="register-form" id="register-form" enctype="multipart/form-data">
                <div class="row mb-20">
				...
				<p> </p>				
				           ...
				           <div class="form-group row" style="margin-left:0px;">
                                <label for="email" class="col-sm-4 col-form-label" style="padding-left: 0px;">ENTER NEW PASSWORD</label>
                                <div class="col-sm-8">
                                    <input type="password" id="password" name="password" placeholder="ENTER ONE TIME PASSWORD">
                                </div>
                            </div>
							
							<div class="form-group row" style="margin-left:0px;">
                                <label for="email" class="col-sm-4 col-form-label" style="padding-left: 0px;">RE ENTER NEW PASSWORD</label>
                                <div class="col-sm-8">
                                    <input type="password" id="c_password" name="c_password" placeholder="RE ENTER ONE TIME PASSWORD">
                                </div>
                            </div>
