...
<div class="simle_view_midde xme_top">	
                ...
                <div class="col-md-5"> <a href="" class="xme_btn"> BACK</a> <a href="<?=base_url();?>xme/contactinfo_account" class="xme_btn"> NEXT</a>  </div>  
				</div>
                <p> To change password, a One Time Password will be sent to your email account.</p>
				...
				<p> To deactivate account, a One Time Password will be sent to your email account.
