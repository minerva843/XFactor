<div class="virtual_view avatar simple_view_outer">
		...
		<div class="tabbable tabs-below">
				...
				<div class="row">
				 ...
				 <a href="#" class="xme_btn" onclick="printJS({printable:'printJS-form-edit_details', type:'html',targetStyles: ['*']})" id="submitSuccback"> PRINT </a> 
				...
				<div class="sml-container" id="printJS-form-edit_details">  
				
				<link rel="stylesheet" href="<?=base_url();?>assets/css/print.css" type="text/css">
				
				<div class="row mb-20">
				<div class="col-md-7"> <h3> PERSONAL INFO (EDIT) <span class="success">SUCCESSFUL </span> </h3>  </div>
