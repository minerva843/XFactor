<div class="virtual_view avatar simple_view_outer">
		...
		<div class="tabbable tabs-below">
				...
				<div class="row">				
				 ...
				 <a href="#" class="xme_btn" onclick="printJS({printable:'printJS-form-company', type:'html',targetStyles: ['*']})" id="submitSuccback"> PRINT </a> 
				<a href="<?=base_url();?>xme/my_details" class="xme_btn">DONE</a> 
				 </div>
				 </div>	
				</div>       

				
				<div class="sml-container" id="printJS-form-company"> 
				<link rel="stylesheet" href="<?=base_url();?>assets/css/print.css" type="text/css">
				<div class="row mb-20">
				<div class="col-md-12"> <h3> PERSONAL INFO <span class="success">SUCCESSFUL </span> </h3>   </div>
                 
				</div>
			
				<p class="mt20"><b><?=$user->last_edit_datetime;?>h.</b> PERSONAL INFO HAS BEEN EDITED.</p>
				<p class="mt20"><b>ALL PERSONAL DETAILS ARE LISTED BELOW :</b></p>
				...
				<div class="col-sm-8">
				<div class="zone-label"><?=$user->company;?></div>
				</div>
				</div>
				...
				<div class="col-sm-8">
				<div class="zone-label"><?=$user->company_address;?></div>
				</div>
				</div>
				...
				<div class="col-sm-8">
				<div class="zone-label"><?=$user->pincode;?></div>
				</div>
				</div>
				...
				<div class="col-sm-8">
				<div class="zone-label"><?=$user->designation;?></div>
				</div>
				</div>
