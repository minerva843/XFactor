...
<div class="simle_view_midde xme_top">	
                ...
                <div class="row mb-20">
				<div class="col-md-7"> <h3> DEACTIVATE ACCOUNT  <span class="success">SUCCESSFUL</span> </h3> </h3>  </div>
                <div class="col-md-5"> <a href="" class="xme_btn"> PRINT</a> <a href="<?=base_url();?>xme/changepassword" class="xme_btn"> DONE</a>  </div>  
				</div>
                <p class="mt20"><b>YYYYMMDD HHMM.</b> YOUR ACCOUNT HAS BEEN DEACTIVATED. </p>
