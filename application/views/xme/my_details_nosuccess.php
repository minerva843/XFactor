<div class="virtual_view avatar simple_view_outer">
		...
		<div class="tabbable tabs-below">
                ...
                <div class="row mb-20">
				<div class="col-md-7"> <h3> PERSONAL INFO (EDIT) <span class="nosuccess">NOT SUCCESSFUL </span> </h3>  </div>
                <div class="col-md-5 text-right"> 
				<a href="#" class="xme_btn"> PRINT </a> 
				<a href="<?=base_url();?>xme/companyinfo_edit" class="xme_btn">RETRY</a>  </div>    
				</div>
				 
				
				<p class="mt20"><b>YYYYMMDD HHMM.</b> . PERSONAL INFO HAS NOT BEEN EDITED. PLEASE TRY AGAIN.</p>
				...
				<div class="col-sm-8">
				<div class="zone-label">MALE / FEMALE / COMPANY</div>
				</div>
				</div>
				...
				<div class="col-sm-8">
				<div class="zone-label">THIS NAME CANNOT BE CHANGED
						...
						<div class="form-group row add-guest">
							...
							<div class="col-sm-8 project-visual">   
								...
								<p class="mt20"><img src="http://13.235.169.150/XFactor/assets/images/chat/workshop-thumb.png"> </p>
						...
						<div class="form-group row add-proj_02 guest_add poject_editor">
							...
							<div class="col-sm-8 project-visual quick_intro_guest">   
							NEW VALUE
