<div class="virtual_view avatar simple_view_outer">
		...
		<div class="tabbable tabs-below">
				...
				<div class="sml-container register-form" id="printJS-form-password">

                <div class="row mb-20">
				<div class="col-md-7"> <h3> CHANGE PASSWORD <span class="success"> SUCCESSFUL </span> </h3>   </div>
               <div class="col-md-5 text-right">
			   <a href="#" class="xme_btn" onclick="printJS({printable:'printJS-form-password', type:'html',targetStyles: ['*']})" id="submitSuccback">PRINT</a>
			   <a href="<?=base_url();?>xme/my_details" class="xme_btn" >DONE</a>  </div>    
				</div>
				
                <p class="mt20"><b><?=$user->last_edit_datetime;?>h.</b> PASSWORD HAS BEEN EDITED. </p>				
				<form>      
