...
<link rel="stylesheet" href="<?=base_url();?>assets/css/style.css" type="text/css">
				...
				<div class="sml-container register-form" id="printJS-form-noaccount">

                <div class="row mb-20">
				<div class="col-md-7"> <h3> DEACTIVATE ACCOUNT <span class="nosuccess">NOT SUCCESSFUL </span> </h3>   </div>
               <div class="col-md-5 text-right">
			   <a href="#" class="xme_btn" onclick="printJS({printable:'printJS-form-noaccount', type:'html',targetStyles: ['*']})" id="submitSuccback">PRINT</a>
			   <a href="<?=base_url();?>xme/my_details" class="xme_btn" >RETRY</a>  </div>    
				</div>
				
                <p class="mt20"><b><?=$user->last_edit_datetime;?>h.</b>  YOUR ACCOUNT HAS NOT BEEN DEACTIVATED. PLEASE TRY AGAIN. </p>				
				<form>      
