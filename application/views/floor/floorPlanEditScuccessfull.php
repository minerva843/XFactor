...
<div class="main-section floor_steps" id="add-floor">
	<div class="container">
		...
		<div class="top-header">
			<div class="row">
				<div class="col-md-9">
					<h2>FLOOR PLANS (EDIT) <b><span class="sucess">SUCCESSFUL </span></b></h2>

					<p> <b><?php echo date('Ymd hi'); ?>h.</b> THIS FLOOR PLAN HAS BEEN EDITED.</p>
				</div>
					...
					<div class="tab right-tabs">
						...
						<div class="table-content">
							...
							<div class="table_info floor-step floorplan-gridsucess floor-plan-addsucess-right" >
								...
								<h5>ALL FLOOR PLAN DETAILS ARE LISTED BELOW :</h5>

								<div class="floorpalns" id="printJS-form-floor-edit">
						  ...
						  <div class="col-sm-6 floor-result-1">FLOOR PLAN GRID TYPE </div>
						   <div class="col-sm-6 floor-result"> : 16 x 9</div>
									...
									<div class="row">
										<div class="col-sm-6 floor-result-1"> FLOOR IMAGE </div>
										<div class="col-sm-6 floor-result"><img src="<?php echo base_url() . 'assets/floor_plan/' . $data->file_name . $data->file_type; ?>" alt="your image"> </div>
									</div>
							...
							<div class="form-submit">
								<input type="button" value="PRINT" class="action-btn" onclick="printJS({printable:'printJS-form-floor-edit', type:'html',targetStyles: ['*']})" id="submitSuccback">
								<input type="submit" value="DONE" class="action-btn" id="toHome">
							</div>
						</div>
					</div>
	...
	<script>
		...
		// $('body').on('click', '#close-btnfloorstep3', function () {
            // $.fancybox.close(); 
            // window.location.href = "<?php echo base_url(); ?>floor/deleteJunkRecord/<?php echo $id; ?>/<?php echo $group_id; ?>/<?php echo $project_select; ?>/<?php echo $action; ?>/1";
