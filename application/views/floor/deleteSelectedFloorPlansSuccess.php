    ...
    <div class="container">
        ...
        <div class="top-header">
            <div class="row">
                <div class="col-md-9"><?php //print_r($zone[0]);  
                                        ?>
                    <h2>FLOOR PLANS (DELETE) <span class="sucess">SUCCESSFUL </span></h2>
                    <p><b><?php echo date('Ymd hi'); ?>H.</b> ALL SELECTED FLOOR PLANS HAVE BEEN DELETED.</p>
                </div>
        ...
        <div class="middle-body register-form zone-sucess">
            <div class="row">
                <div class="col-md-9">
                    <div class="row">
                        <div class="delete-spacing"></div>
                    </div>
                    <div class="leftbox-top">
                        <h5> ALL SELECTED FLOOR PLANS THAT ARE DELETED ARE LISTED BELOW :</h5>
                    </div>

                    <div class="zone-info delete-sepation delete-floorplan-selected">
                        <div class="col-md-12" id="printJS-form-floor-deleteselectedid">
                                    ...
                                    <div class="col-md-9">
                                        ...
                                        <form>
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-5">
                                                    <div class="zone-label"><?php if (!empty($data['last_edited_date_time'])) {
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-5">
                                                    <div class="zone-label"><?php if (!empty($data['last_edited_ip_address'])) {
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-5">
                                                    <div class="zone-label"><?php if (!empty($data['last_edited_xmanage_id'])) {
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-5">
                                                    <div class="zone-label"><?php if (!empty($data['last_edited_username'])) {
						  ...
						  <div class="col-md-6 floor-result-1">FLOOR PLAN GRID TYPE </div>
						   <div class="col-md-6 floor-result"> : 16 x 9</div>
											...
											<div class="form-group row">
												<label for="colFormLabel" class="col-sm-3 col-form-label">FLOOR IMAGE</label>
												<div class="col-sm-5">
                                                    <div class="zone-label"><img src="<?php echo base_url() . 'assets/floor_plan/' . $data['file_name'] . $data['file_type']; ?>" alt="your image"> </div>
                                                </div>
											</div>
                        ...
                        <div class="table-content">
                            ...
                            <div class="table_info floor-step">
                                ...
                                <p><span class="current-bold">CURRENTLY SELECTED :</span> <span style="color:black;font-size: 14px;"><?php if ($_SESSION['Singledata'] == 1) {
                                                                                                                                        echo $_SESSION['SelectedDelete'][0]['floor_plan_name'];
                                                                                                                                    } else {
                                                                                                                                        echo "MULTIPLE FLOOR PLANS";
                                                                                                                                    } ?></span></p>
                                <br>
                            ...
                            <div class="form-submit">
                                <input type="button" value="PRINT" class="action-btn" onclick="printJS({printable:'printJS-form-floor-deleteselectedid', type:'html',targetStyles: ['*']})" id="submitSuccback">
...
<?php
session_unset('Singledata');
session_unset('SelectedDelete');
session_unset('SelectedIds');
