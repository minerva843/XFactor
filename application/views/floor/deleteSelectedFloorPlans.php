        ...
        <div class="middle-body register-form zone-sucess ">
            <div class="row">
                <div class="col-md-9">
                    ...
                    <div class="zone-info delete-floorplan-selected">
					...
					<div class="col-md-9">
                        ...
                        <form>
                            ...
                            <div class="form-group row delete-secet-space">
...
<!--                                 <a class="nav-item nav-link" id="nav-contact-tab" data-toggle="tab" href="#nav-contact" role="tab" aria-controls="nav-contact" aria-selected="false">Project Tab 3</a> -->
                            ...
                            <div class="table_info floor-step">
                                ...
                                <p><span class="current-bold">CURRENTLY SELECTED :</span> <span style="color:black;font-size: 14px;" >
						    ...
						    <p><b>ARE YOU SURE YOU WANT TO <span style="color:red; font-weight: 600 !important;">DELETE </span> THE SELECTED FLOOR PLANS?</b></p>
                                </div>
                            </div>
