        ...
        <div class="top-header">
            <div class="row">
                <div class="col-md-9"><?php //print_r($zone[0]);  ?>  
                    <h2>FLOOR PLANS (DELETE ALL) </h2>
                   <p style="color:red">DELETE ALL MEANS ALL FLOOR PLANS AND RELATED DATA CANNOT BE RETRIEVED IN FUTURE.</p>
                </div>
        ...
        <div class="middle-body register-form zone-sucess">
            <div class="row">
				...
				<div class="leftbox-top">
					<h5> ALL FLOOR PLANS TO BE DELETED ARE LISTED BELOW :</h5>
					</div>  
                    
                    <div class="zone-info delete-floorplan delete-floorplan-all">
...
<!--                                 <a class="nav-item nav-link" id="nav-contact-tab" data-toggle="tab" href="#nav-contact" role="tab" aria-controls="nav-contact" aria-selected="false">Project Tab 3</a> -->
						    ...
						    <p><b>ARE YOU SURE YOU WANT TO <span style="color:red; font-weight:600 !important;">DELETE ALL</span> FLOOR PLANS?</b></p>
                                </div>
                            </div>
