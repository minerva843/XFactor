...
<div class="main-section fancybox-content" id="add-floor" style=""> 
    <div class="container">
        ...
        <div class="top-header">
            <div class="row">
                <div class="col-md-9">  
                    <h2>ON DEMAND CONTENT (ADD) <span class="sucess">SUCCESSFUL </span></h2>
                    <p> <b><?php echo date('Ymd hi'); ?>h.</b>  THIS ON DEMAND CONTENT HAS BEEN ADDED.</p>
                </div>
        ...
        <div class="middle-body register-form zone-sucess"> 
            <div class="row">
	            ...
	            <div class="leftbox-top">
					...
					<div class="col-md-12" id="printJS-form-ondemand-add">
				...
				<li class="active"><a data-toggle="tab" href="#menu1">MAIN MENU</a></li>
                            ...
                            <div class="table_info floor-step">
                                <p><span class="current-bold">CURRENTLY SELECTED</span> : <span style="color:black;font-size: 14px;">ON DEMAND CONTENT (ADD)</span></p>
                            ...
                            <div class="form-submit"> 
                                <input type="button" value="PRINT" class="action-btn" onclick="printJS({printable:'printJS-form-ondemand-add', type:'html',targetStyles: ['*']})" id="submitSuccback">
