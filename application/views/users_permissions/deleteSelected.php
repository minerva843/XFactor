                    ...
                    <div class="tab right-tabs">
                        ...
                        <div class="table-content">
                            <ul class="nav nav-tabs ">
                                ...
                                <li id="group_chat_list8"><a data-toggle="tab"  href="#menu2">PERMISSIONS</a></li>
                                <li class=""><a data-toggle="tab" href="#menu3">ASSIGN USERS</a></li>

                            </ul>
                            <div class="table_info floor-step">

                                <p><span class="current-bold">CURRENTLY SELECTED :</span> <span style="color:black;font-size: 14px;"><?php if ($selected && !$single) {
                                ...
                                <br>
                                <p><b>TO CHECK AGAIN BEFORE <span style="color:red; font-weight: 600!important;"><?php echo $action; ?></span>, CLICK BACK.</b></p><br />
                                <p><b>ARE YOU SURE YOU WANT TO <span style="color:red; font-weight: 600!important;"><?php echo $action; ?> </span> <?php if ($selected) {
                                                                                                                                                echo 'THE SELECTED';
                                                                                                                                            } else {
                                                                                                                                                echo 'ALL';
                                                                                                                                            } ?>GROUPS ?</b></p>
