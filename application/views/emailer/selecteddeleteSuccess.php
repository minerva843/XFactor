        ...
        <div class="top-header">
            <div class="row">
                <div class="col-md-9"><?php //print_r($zone[0]);  ?>  
                    <h2>EMAILER (DELETE) <span class="sucess"> SUCCESSFUL </span></h2>
                    <p><b><?php echo date('Ymd hi'); ?>h.</b> ALL SELECTED EMAILER HAS BEEN DELETED</p>
                </div>
                <div class="col-md-3">
        ...
        <div class="middle-body register-form zone-sucess">
            <div class="row">
				...
				<div class="row">
					...
					<h5>ALL SELECTED EMAILER TO BE DELETED ARE LISTED BELOW : </h5>
					</div>
					</div>
					</div>	
                    <div class="floor-sec floor-add">
					<div class="tab-listing">
                    <div class="zone-info" id="printJS-form-program-delete-selected">
                ...
                <div class="col-md-3 right-text">
                    <div class="tab right-tabs">
						  ...
						  <p style="color:#00b050!important;font-weight: bold!important;"><span class="current-bold">CURRENTLY SELECTED :</span> <span style="color:black;font-size: 14px;font-weight: bold;" ><?php if($_SESSION['Singledata'] == 1){
									echo $_SESSION['SelectedDelete'][0]->emailer_title;
								}else{
									echo "MULTIPLE EMAILER";
								}?></span></p>
						 ...
						 <div class="form-submit">
							...
							<input type="button" value="PRINT" class="action-btn" onclick="printJS({printable:'printJS-form-program-delete-selected', type:'html',targetStyles: ['*']})" id="submitSuccback">
