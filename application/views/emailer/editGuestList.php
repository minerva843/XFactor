...
<div class="main-section" id="floor-sort"> 
  ...
  <div class="modal-content">
   <div class="modal-body">
    <h4>EMAILER (EDIT) <span style="color:red">NOT SUCCESSFUL</span></h4>
...
<script type="text/javascript">
 $("body").on('click','#btn5',function(){
        ...
        autoSize  : true,
        type        : "ajax",
        src         : "<?php echo base_url(); ?>emailer/edit/<?php echo $data1->id;?>",
        ajax: { 
...
$("#submitbtn").click(function() {
	...
	$.ajax({  
		...
		{ 
			...
			autoSize  : true,
			type        : "ajax",
			src         : '<?php echo base_url(); ?>emailer/vieweditSuccessful/'+data,
			ajax: {  
...
$('body').on('click', '#close-btneditpro2', function () {
	...
	window.location.href = "<?php echo base_url(); ?>emailer/deleteJunkRecord/<?php echo $data1->id; ?>/<?php echo $group_id; ?>/<?php echo $project_select; ?>/EDIT/2";
                    ...
                    <div class="tab right-tabs">
                        ...
                        <!--         <li><a data-toggle="tab" href="" class="allassign">ALL ASSIGNMENTS</a></li>
                            ...
                            <div class="table_info floor-step">
                                <p> <span style="color:#00b050;"><span class="current-bold">CURRENTLY SELECTED :</span> EMAILER (EDIT)</p>
								 <h5>STEP 2 OF 2</h5>
