        ...
        <div class="top-header">
            <div class="row">
                <div class="col-md-9"><?php //print_r($zone[0]);  ?>  
                    <h2>EMAILER (DELETE)</h2>
                    <p style='color:red;'> DELETE MEANS ALL SELECTED EMAILER AND RELATED DATA CANNOT BE RETRIEVED IN FUTURE. </p>
                </div>
                ...
                <div class="col-md-3 right-text master-floor-left">
                    <div class="tab right-tabs">
						  ...
						  <p style="color:#00b050!important;font-weight: bold!important;"><span class="current-bold">CURRENTLY SELECTED :</span> <span style="color:black;font-size: 14px;font-weight: bold;" ><?php if($_SESSION['Singledata'] == 1){
						    ...
						    <p><b>ARE YOU SURE YOU WANT TO <span style="color:red;font-weight:bold !important;">DELETE </span> THE SELECTED EMAILER?</b></p>
							</div>
...
function myFunction() {
  ...
  x.disabled = true;
        ...
        autoSize  : true,
        type        : "ajax",
        src         : "<?php echo base_url(); ?>emailer/EmailerselecteddeleteSuccess",
        ajax: { 
           settings: { data : 'project=<?=$project?>&group_id=<?=$group_id?>', type : 'POST' }
        },
        touch: false,
