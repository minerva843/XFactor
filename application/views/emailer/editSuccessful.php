...
<div class="main-section fancybox-content" id="add-floor" style="">
    <div class="container">
        ...
        <div class="top-header">
            <div class="row">
                <div class="col-md-9">
                    <h2>EMAILER (EDIT) <span class="sucess">SUCCESSFUL </span></h2>
                    <p> <b><?php echo date('Ymd hi'); ?>h.</b> THIS EMAILER HAS BEEN EDITED.</p>
                </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-5">
                                    <div class="zone-label">XCFP123456789012</div>
                                        ...
                                        <div class="form-group row">
                                            <label for="colFormLabelSm" class="col-sm-4 col-form-label col-form-label-sm">EMAILER IMAGE 1</label>
                                            <div class="col-sm-8">
                                                 <div class="zone-label"> 
												 <?php if($data1->image1){?>
										...
										<div class="form-group row">
                                            <label for="colFormLabelSm" class="col-sm-4 col-form-label col-form-label-sm">EMAILER IMAGE 2</label>
                                            <div class="col-sm-8">
                                                 <div class="zone-label"> 
												 <?php if($data1->image2){?>
												 <img src="<?=base_url().'assets/emailer/'.$data1->image2?>" style="width:150px;">
												 <?php }else{ echo 'NIL';}?>
												 </div>
                                            </div>
                                        </div>
										<div class="form-group row">
                                            <label for="colFormLabelSm" class="col-sm-4 col-form-label col-form-label-sm">EMAILER IMAGE 3</label>
                                            <div class="col-sm-8">
                                                 <div class="zone-label"> 
												 <?php if($data1->image3){?>
												 <img src="<?=base_url().'assets/emailer/'.$data1->image3?>" style="width:150px;"> 
												 <?php }else{ echo 'NIL';}?>
												 </div>   
                                            </div>
                                        </div>
                    ...
                    <div class="tab right-tabs">
                        ...
                        <div class="table-content">
                            ...
                            <div class="table_info floor-step">
                                <div class="status">
                                    <p style="color:#00b050!important; font-weight: bold!important;"><span class="current-bold">CURRENTLY SELECTED :</span> <span style="color:black; font-size: 14px;">EMAILER (EDITED)</span></p>
