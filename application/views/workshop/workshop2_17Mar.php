											...
											<select id="selectWorkshop">
												...
												?>
													...
													<option value="<?php echo $workshop['id']; ?>" <?php if ($workshop['id'] == $workshopid) {
																										echo 'selected';
																									} ?>><?php echo $stausworkshop; ?>, <?php echo $workshop['startdatetime']; ?>, <?php echo $workshop['enddatetime']; ?>, <?php echo $workshop['workshop_name']; ?>, <?php echo $workshop['location']; ?></option>
