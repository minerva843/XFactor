        ...
        <div class="top-header">
            <div class="row">
                <div class="col-md-9">
                    ...
                    <p> <b><?php echo date('Ymd hi'); ?>h.</b> THIS WORKSHOP HAS BEEN <?php echo $action; ?>ED.</p>
                </div>
        ...
        <div class="middle-body register-form zone-sucess">
            <div class="row">
	            ...
	            <div class="leftbox-top">
                    ...
                    <div class="zone-info">
					<div class="col-md-12" id="printJS-form-workshop-add">
					...
					<div class="col-md-9">
                        ...
                        <form>
							...
							<div class="form-group row">
                                <label for="colFormLabel" class="col-sm-4 col-form-label">LAST EDITED XMANAGE ID  </label>
                                <div class="col-sm-8">
                                    <div class="zone-label"><?php echo $workshop->last_edited_username; ?></div>
                                </div>
                            </div>
							...
							<div class="form-group row">
                                ...
                                <div class="col-sm-8">
                                    <div class="zone-label"><?php echo $workshop->screenremarks1; ?></div>
                                </div>
                                </div>
							...
							<div class="form-group row">
                                ...
                                <div class="col-sm-8">
                                    <div class="zone-label"><?php echo $workshop->screenremarks2; ?></div>
                                </div>
                                </div>
							...
							<div class="form-group row">
                                ...
                                <div class="col-sm-8">
                                    <div class="zone-label"><?php echo $workshop->screenremarks3; ?></div>
                                </div> 
                                </div>
                    ...
                    <div class="tab right-tabs">
                        ...
                        <div class="table-content">	      
                            ...
                            <div class="form-submit"> 
                                <input type="button" value="PRINT" class="action-btn" onclick="printJS({printable:'printJS-form-workshop-add', type:'html',targetStyles: ['*']})" id="submitSuccback">
