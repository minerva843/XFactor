                        ...
                        <h3>WORKSHOP INFO</h3>  				
                            ...
                            <div class="form-group row mb-4">
                                ...
                                <div class="col-sm-5">
                                    ...
                                    <input type="url" maxlength="250" placeholder="INPUT HTTP:// OR HTTPS:// BEFORE WEBSITE ADDRESS." class="running_latter"  name="screenurl1" id="screenurl1" value="<?php echo $workshop->screenurl1;  ?>" />
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-5">
                                    <input type="text" name="screenremarks2"  value="<?php echo $workshop->screenremarks2; ?>" class="form-control running_latter" id="screenremarks2" placeholder="ENTER WORKSHOP SCREEN REMARKS 2">
                                </div>
                            </div>
                            ...
                            <div class="form-group row mb-4">
                                ...
                                <div class="col-sm-5">
                                   <input type="url" name="screenurl2" maxlength="250"   value="<?php echo $workshop->screenurl2; ?>" class="form-control running_latter" id="screenurl2" placeholder="INPUT HTTP:// OR HTTPS:// BEFORE WEBSITE ADDRESS."> 
                             ...
                             <div class="form-group row">
                                ...
                                <div class="col-sm-5">
                                    <input type="url" name="screenurl3" maxlength="250"  value="<?php echo $workshop->screenurl3; ?>" class="form-control running_latter" id="screenurl3" placeholder="INPUT HTTP:// OR HTTPS:// BEFORE WEBSITE ADDRESS.">
                                </div>
                            </div>
...
<script>
	...
	clickSlide: false,
        ...
        $('body').on('click', '.close-btn', function () {
            $.fancybox.close();
             					window.location.href = "<?php echo base_url(); ?>workshop/deleteJunkRecord/<?php echo $workshop_id; ?>/<?php echo $this->session->userdata('group_id'); ?>/<?php echo $project_select; ?>/<?php echo $action; ?>/2";
