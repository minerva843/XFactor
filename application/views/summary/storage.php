			...
			<div class="row avatar-main">
				...
				<div class="col-md-9 chatscreen">
					...
					<div class="row">
						...
						<a href="<?=base_url();?>home/storage/<?php echo $group_id;?>/<?php echo $project_id;?>" class="active">
				...
				<div class="col-md-3 avtar-sidebar">
					<div class="tabbable tabs-below table-content">
						...
						<td><?php echo $total_storage;?> GB</td>
					  </tr>
					  ...
					  <tr>
						<td>CONTENT SETS</td>
						<td><?php echo $on_content_set_storage;?> GB</td>
					  </tr>
					  
					  <tr>
						<td>ON DEMAND CONTENT</td>
						<td><?php echo $on_demand_set_storage;?> GB</td>
					  </tr>
					     
						<tr>
							<td>POST</td>
							<td><?php echo $on_post_storage;?> GB</td>
						</tr>
						 
					  <!--<tr>
						<td>CHAT ATTCHMENT CACHE</td>
						<td><?php echo '';?> GB</td>
					  </tr>-->
					  
					  <tr>
							<td>OTHERS</td>
							<td><?php echo $on_others_storage;?> GB</td>
						</tr>
