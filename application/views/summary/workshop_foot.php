...
<img id="demo-4" class="floorimg" src="http://13.235.169.150/XFactor/assets/floor_plan/floor_plan29406012020-12-16.jpeg" alt="your image" style="width:px;height:px">
</div>
...
?>
	<li class="active">
<a href="<?=base_url();?>home/figures/<?php echo $group_id;?>/<?php echo $project_id;?>" class="active"><img src="<?=base_url();?>assets/images/chat/figure.png" class="img-fluid"><span>FIGURES</span></a>
</li>       
<li>
