			...
			<div class="row avatar-main">
				...
				<div class="col-md-9 chatscreen">
					...
					<div class="sumry_stac_cont">
						...
						<div class="col-md-2">
						<div class="summery_logo mb-15">
						<a href="<?=base_url();?>home/workshop/<?php echo $group_id;?>/<?php echo $project_id;?>" class="active">
				...
				<div class="col-md-3 avtar-sidebar">
					<div class="tabbable tabs-below table-content">
						...
						<tr>
						<td colspan="2" class="spc_clas sum_font"><b>TOTAL UNIQUE VISITORS </b></td>
						...
						<tr>
							...
							<td><?php echo $workshop_signed_visitors_today;?></td>
							</tr>

							<tr>
							<td>TOTAL UNIQUE VISITORS, SIGNED IN, FROM PROJECT START DATE</td>
							<td><?php echo $workshop_signed_visitors_start;?></td>
							</tr>
							<tr>
							<td>TOTAL UNIQUE VISITORS, NOT SIGNED IN, TODAY</td>
							<td><?php echo $workshop_not_signed_visitors_today;?></td>
							</tr>
								
							<tr>
							<td>TOTAL UNIQUE VISITORS, NOT SIGNED IN, FROM PROJECT START DATE</td>
							<td><?php echo $workshop_not_signed_visitors_start;?></td>
							</tr>
							<tr>
						...
						<tr>    
							<td class="workTop sum_font"><b>TOTAL WORKSHOPS</b></td>
							<td class="sum_font"><?php echo $total_workshop;?></td>
						</tr>
						<tr>
							<td colspan="2" class="res_clas sp_abc a-space"></td>	 
							</tr>
						<tr>
							<td class="workTop sum_font"><b>TOTAL ATTENDEES</b></td>
							<td class="sum_font"><?php echo $total_attendees;?></td>  
						</tr>
						...
						<p class="workTop mb-2"><b>MOST ATTENDED  (TOP 5)</b>	</p>				
						<?php //print_r($workshop); die; 
						foreach($workshop as $wK => $wp){ //print_r($wk);
							if($wK<=4) {?>
							<p><b>#<?php echo $wK+1;?> WORKSHOP NAME : <?php echo $wp['Name'];?></b></p>
							<table>	
							<tr>							
							<td>TOTAL ATTENDEES </td>
							<td> <?php echo $wp['total_attendees'];?></td>
							</tr>
							<tr>
							<td>TOTAL ATTENDEES (PEAK) </td>
							<td> <?php echo $wp['attendees'];?></td>
							</tr>
							<tr>
							<td>TOTAL ATTENDEES (PEAK TIME)</td>
							<td> <?php echo $wp['peak_attendees'].' h';?></td>
							</tr>
							<tr>
							<td>AVERAGE ATTENDEES PER HOUR </td>
							<td> <?php echo $wp['avg_attendees'];?></td>
							</tr>
							<tr>
							<td>AVERAGE STAY TIME </td>
							<td> <?php echo $wp['avg_stay_time'].' sec';?></td>
							</tr>
							<tr>
							<td>SCREEN URL1 </td>
							<td> </td>
							...
							<tr>
							<td colspan="2" class="res_clas sp_abc running_latter"> <?php echo $wp['screenurl1'];?> </td>
							</tr>
							
							<tr>
							<td>SCREEN REMARKS1 </td>
							<td> </td>
							</tr>
							
							<tr>
							<td colspan="2" class="res_clas sp_abc"> <?php echo $wp['screenremarks1'];?> </td>
							</tr>
							
							<tr>
							<td>SCREEN URL1 CLICK </td>
							<td> <?php echo $wp['screenclick1'];?> </td>
							</tr>
							...
							<tr>
							<td colspan="2" class="res_clas sp_abc running_latter"> <?php echo $wp['screenurl2'];?> </td>
							</tr>
							
							<tr>
							<td>SCREEN REMARKS2 </td>
							<td> </td>
							</tr>
							
							<tr>
							<td colspan="2" class="res_clas sp_abc"> <?php echo $wp['screenremarks2'];?> </td>
							</tr>
							
							<tr>
							<td>SCREEN URL2 CLICK </td>
							<td> <?php echo $wp['screenclick2'];?></td>
							</tr>
							<tr>
							<td>SCREEN URL3 </td>
							<td></td>
							...
							<tr>
							<td colspan="2" class="res_clas sp_abc"> <?php echo $wp['screenurl3'];?>  </td>
							</tr>
							
							<tr>
							<td>SCREEN REMARKS3 </td>
							</tr>
							
							<tr>
							<td colspan="2" class="res_clas sp_abc"> <?php echo $wp['screenremarks3'];?> </td>
							</tr>
							
							<tr>
							<td>SCREEN URL3 CLICK </td>
							<td> <?php echo $wp['screenclick3'];?></td>
							</tr>
							</table>
							<hr/>
						<?php } }?>
						...
						<div class="sumry_stac_down">	
						<p class="workTop"><b>WORKSHOP (NOT IN TOP 5) </b></p>						
						<?php //print_r($workshop); die; 
						foreach($workshop as $wK => $wp){
							//print_r($wk);
							if($wK>4) {?>
							<p>#<b><?php echo $wK+1;?> WORKSHOP NAME : <?php echo $wp['Name'];?></b></p>
							<table>	
							...
							<tr>
							<td>SCREEN REMARKS1 </td>
							<td> <?php echo $wp['screenremarks1'];?></td>
							</tr>
							<tr>
							<td>SCREEN URL1 CLICK </td>
							<td> </td>
							...
							<tr>
							<td colspan="2" class="res_clas sp_abc"> <?php echo $wp['screenclick1'];?> </td>
							</tr>
							...
							<tr>
							<td>SCREEN REMARKS2 </td>
							<td> <?php echo $wp['screenremarks2'];?></td>
							</tr>
							<tr>
							<td>SCREEN URL2 CLICK </td>
							<td> <?php echo $wp['screenclick2'];?></td>
							...
							<tr>
							<td colspan="2" class="res_clas sp_abc running_latter"> <?php echo $wp['screenurl3'];?> </td>
							</tr>
							...
							<tr>
							<td> <?php echo $wp['screenremarks3'];?></td>   
							</tr>
							<tr>
							<td>SCREEN URL3 CLICK </td>
							<td> <?php echo $wp['screenclick3'];?></td>
