			...
			<div class="row avatar-main">
				...
				<div class="col-md-9 chatscreen">
					...
					<div class="row">
						...
						<a href="<?=base_url();?>home/chat/<?php echo $group_id;?>/<?php echo $project_id;?>" class="active">
