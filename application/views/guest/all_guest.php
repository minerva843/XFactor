                    ...
                    <div class="master-floorplan">
                        <div class="floor-sec"> 
							...
							<option value="GUEST_edited_earliest">LAST EDITED (EARLIEST FIRST)</option>
                                ...
                                <div class="floor-table GUEST-table  GUEST-table-listing scroll-half">
											 ...
											 //    $(".form-submit-btn").removeClass('hide');
											    ...
											    ///  $(".chk2").css("display","none");
											      $("#ViewSingleData").find("#multipleGUESTSelect").text(" NO GUEST SELECTED");
												   $("#ViewSingleData").empty().html('<p><span class="current-bold">CURRENTLY SELECTED : </span> NO GUEST SELECTED</p><p><span class="current-bold">CURRENTLY VIEWING : </span> NO GUEST SELECTED</p>');
...
$("body").on('click','#AddGUEST',function(){
      ...
      $.fancybox.open({
        ...
        type        : "ajax",
        src         : '<?=base_url();?>file_upload/all_guest_uploads',
        ajax: { 
           settings: { data : 'project=<?php echo $project_select; ?>&group_id=<?php echo $group_id; ?>', type : 'POST' }
        },
        touch: false,
