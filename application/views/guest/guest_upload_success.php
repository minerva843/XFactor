 ...
 <P><b>ALL GUEST LIST DETAILS THAT WERE ENTERED ARE LISTED BELOW :</b></P> <br>
		  ...
		  <h5 id="fp"></h5>
                            ...
                            <div class="form-submit"> 
								<a href="#" class="action-btn backbtn" style="display:none;" name="back" id="btn57f899hd">BACK</a>
								<input type="button" value="DONE" class="action-btn FloorSubmit" name="submit" id="btn5nextsuccessupload345">
                            </div>
                        </div>
                    </div>
                </div>
...
$(document).ready(function(){
	...
	$("body").on('click','#btn5nextsuccessupload345',function(){
