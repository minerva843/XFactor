									...
									<div id="chat5" class="container tab-pane active">
										<div class="table_info">
											...
											<div class="nearme-box chat-top-profile">
												...
												<img src="<?php echo base_url('assets/group_chat_images/' . $grpD->chat_image); ?>">
												<?php }
													else{ ?>
													<img src="<?php echo base_url('assets/images/chat/GROUP_CHAT_DEFAULT_IMAGE.png'); ?>">
		...
		//} else {
			$.ajax({
				...
				success: function(response) {
					...
					$("#chatbox_t3").append(response);
					$('#chatbox_t3').animate({
						scrollTop: $('#chatbox_t3')[0].scrollHeight
					}, 1000);
				}
			});
		//}
