        ...
        <div class="top-header">
            <div class="row">
                <div class="col-md-9">
                   ...
                   <p style="color:red">DELETE <?php if($selected){  }else{echo 'ALL';} ?> MEANS <?php if($selected){ echo 'ALL SELECTED'; }else{echo 'ALL';} ?> CONTENT SETS AND RELATED DATA CANNOT BE RETRIEVED IN FUTURE.</p>
                </div>
        ...
        <div class="middle-body register-form zone-sucess content-delete-single">
            <div class="row">
				...
				<div class="leftbox-top">
					<h5> ALL CONTENT SETS TO BE DELETED ARE LISTED BELOW : </h5>
					</div>  
...
<?php ///print_r($data);  ?>
				...
				<li class="active"><a data-toggle="tab" href="#menu1">MAIN MENU</a></li>
                            ...
                            <div class="table_info floor-step">
                                ...
                                <p style="color:#00b050!important;"><span class="current-bold">CURRENTLY SELECTED :</span> <span style="color:black;font-size: 14px;font-weight: normal;" >ALL CONTENT SET</span></p>
