<?php defined('BASEPATH') OR exit('No direct script access allowed'); ?>
 <style>
  ...
  <div class="main-section fancybox-content" id="content-sort" style="display: inline-block;">
    <div class="container">
                    ...
                    <div class="floor-sec"> 
						<div class="tab-listing">
						   ...
						   <select class="dropdown" name="content_set_aasign" id="selectData">
							<option value=" ">SELECT ALL CONTENT SET</option>
						  ...
						  <div class="col-md-2">
					 	  <select class="dropdown" id="selectShortBy">
							...
							<div class="col-md-1"><button class="src-btn1" id="deleteAllcontent">DELETE ALL</button></div>
						  </div>
							      
					<div class="floor-table project-table  project-table-listing take_a_look_s">
...
$(document).ready(function(){
  ...
  $('.closeeditgroup').click(function() {
                                            var modal = document.getElementById("myModal1content");
                                            modal.style.display = "none";

                                            var modal2 = document.getElementById("myModalcontentset23");
...
<script type="text/javascript">
	...
	$("body").on('click','#assign_content',function(){
      ...
      $("body").on('click','#deleteAllcontent',function(){
...
if($("#editAction").hasClass('activebtn')){	
        ...
        clickOutside: false
            ...
            var modal = document.getElementById("myModal1content");
				var span = document.getElementsByClassName("closeeditcontent")[0];
				modal.style.display = "block";
				span.onclick = function() {
				  modal.style.display = "none";
				}
...
if(ids==''){
		...
		var modal = document.getElementById("myModalcontentset23");
		var span = document.getElementsByClassName("closedeletecontent")[0];
		modal.style.display = "block";
		span.onclick = function() {
		  modal.style.display = "none";
		}
...
load_data(selectData, selectShortBy,Allsearch);
 ...
 function load_data(selectData='',selectShortBy='',Allsearch='')
 {
  ...
  $.ajax({
   ...
   {
	//console.log(data);
	//$('#AllDataContent').empty(); 
    $('#AllDataContent').html(data);
   } 
  })
 }
                ...
                <div class="col-md-3 right-text master-floor-left">
					...
					<div class="current-status">
					  ...
					  <table id="ViewSingleData">
                       <p class="viewp"><span class="current-bold">CURRENTLY SELECTED:</span> NO CONTENT SET SELECTED</p>
       ...
       <div class="footer">2019 – <?php echo date('Y'); ?>. <b>XPLATFORM</b>. </div> 
                                    ...
                                    <div id="myModal1content" class="modal delete-sorting">
					...
					<div class="modal-body">
                                ...
                                <div class="modal-footer text-right"><span class="close closeeditcontent closeeditgroup">OK</span> </div>								
                                   </div> 									

                                </div>

                                <div id="myModalcontentset23" class="modal delete-sorting">
					...
					<div class="modal-body">
                                ...
                                <div class="modal-footer text-right"><span class="close closedeletecontent closeeditgroup">OK</span> </div>								
                                   </div> 									
