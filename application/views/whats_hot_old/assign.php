...
<div class="main-section poject-listing-QT" id="floor-sort"> 
    <div class="container">
        ...
        <div class="top-header">
            <div class="row">
                <div class="col-md-9">
                    <h2>WHAT'S HOT (ASSIGN)<span id="actiontopText"style="font-size:18px;" ></span></h2>
                </div>
                                        ...
                                        //if($("#PosteditProject").hasClass('activebtn')){
                                            ...
                                            $.fancybox.getInstance('close');
											 ...
											 $.fancybox.open({
												...
												autoSize  : true,
												type        : "ajax",
												src         : "<?php echo base_url(); ?>whats_hot/assignslots/" + currentid,
												ajax: { 
												   settings: { data : 'id='+currentid, type : 'POST' }
												},
												touch: false,
														clickSlide: false,
												clickOutside: false
