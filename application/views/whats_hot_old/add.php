...
<form action="<?php echo base_url(); ?>post/addstep1post" method="POST" id="addZone">
				...
				<!-- 	<h5> ENTER ZONE DETAILS THAT ARE LISTED BELOW :</h5> -->
                    ...
                    <div class="zone-info add-conents post-video-listing">
						...
						<div class="form-group row">
							...
							<div class="col-sm-5">
								<input type="url" maxlength="50" name="whatshot_btnurl" class="whatshot_btnurl" value="<?php if(!empty($data1->whatshot_btnurl)){ echo $data1->whatshot_btnurl; } ?>" class="form-control" id="whatshot_btnurl" placeholder="Enter WHAT'S HOT BUTTON URL">
							</div>
						</div>
	...
	toolbar: [
		...
		{ name: 'basicstyles', items: [ 'Bold', 'Italic' ] }
								...
								<br>
								<p class="file-extan bs"><b>FILE FORMAT FOR IMAGE FILES TO BE IN JPG/PNG. EACH FILE NOT EXCEEDING 5 MB.</b></p>
								<p class="file-extan bs"><b>FILE FORMAT FOR VIDEO FILES TO BE IN MP4. EACH FILE NOT EXCEEDING 50 MB.</b></p>
                    ...
                    <div class="tab right-tabs">
                        ...
                        <div class="table-content">	  
                            ...
                            <div class="table_info floor-step">                                
                                <p><span style="color: #00b050;">CURRENTLY SELECTED :</span> WHAT'S HOT (<?=$action;?>)</p>
