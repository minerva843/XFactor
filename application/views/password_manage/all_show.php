                    ...
                    <div class="master-floorplan">
                        <div class="floor-sec">
							...
							<option value="GUEST_edited_earliest">LAST EDITED (EARLIEST FIRST)</option>
                                    ...
                                    <div class="col-md-1"><button class="src-btn1 " id="editAction">RESET PASSWORD</button></div>
                                ...
                                <div class="floor-table user-userlist-shorting scroll-half">  
                                    ...
                                    <P>TOTAL USERS COUNT : <?php echo count($ucount); ?></P>
                                    <br>
                                ...
                                <script>
                                    $(document).ready(function() {
                                            ...
                                            if ($("#editAction").hasClass('activebtn')) {
                                                ...
                                                if (grp_id) {
                                                    ...
                                                    $.fancybox.open({
                                                        ...
                                                        autoSize: true,
                                                        type: "ajax",
                                                        src: '<?= base_url(); ?>PasswordManage/addNewUserMain/' + grp_id,
                                                        ajax: {
                                                            settings: {
                                                                data: '',
                                                                type: 'POST'
                                        ...
                                        function load_data(guest = '', shortby = '', Allsearch = '') {
                                            ...
                                            $.ajax({
                                                url: "<?= base_url(); ?>PasswordManage/searchUserManageMaster",
                                                method: "POST",
                                                data: {
                                                    selectData: guest,
                                        ...
                                        $("body").on('click', '.viewusermainlist', function() {
                                            ...
                                            let id = $(this).attr("id");
                                            $.ajax({
                                                url: "<?= base_url(); ?>PasswordManage/searchSingleDataUserById",
                                                method: "POST",
                                                data: {
                                                    id: id
                                                },
...
<div id="myModal1usergroup" class="modal delete-sorting">
    ...
    <div class="modal-content">
        <div class="modal-body">
            <h4>PASSWORD RESET <span style="color:red ;font-weight:bold;">NOT SUCCESSFUL </span></h4>
