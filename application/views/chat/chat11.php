...
<div class="chat-feature">		
		<div class="avtar-left">
			<img src="../assets/images/avtar-left-img.jpg" class="img-fluid">
		</div>
...
<div class="row">
    <div class="col-md-5">
        ...
        <?php if(!empty($user->avatar)){ ?>
           ...
           <a id="avatar_small_dyanmic_dn" href="../assets/svgavatar/for_upload/svgavatars/temp-avatars/<?php echo $user->avatar; ?>" download><img id="avatar_small_dyanmic"  src="../assets/svgavatar/for_upload/svgavatars/temp-avatars/<?php echo $user->avatar; ?>" class="img-fluid" > </a>  
            
        <?php  }else{ ?>
            <a id="avatar_small_dyanmic_dn" href="../assets/images/avatar-small.jpg" download><img id="avatar_small_dyanmic"  src="../assets/images/avatar-small.jpg" class="img-fluid" > </a> 
        <?php } ?>
...
<!--<img src="../assets/images/avatar-big.jpg" class="img-fluid">-->
...
<div class="nearme-box clearfix">
<img src="../assets/images/chat/avtar.png" alt="">
<div class="nearme-detail">
<p>Speaker, MS Susan Sharon , HPE 20 Meters Away</p>
</div>
</div>
...
<h2> WHAT DO YOU WISH TO DO? </h2>
				...
				<li>
<a href="#" data-toggle="tab"><img src="../assets/images/chat/places.png" class="img-fluid"><span>PLACES</span></a>
</li>
<li class="active">
<a href="#1" data-toggle="tab"><img src="../assets/images/chat/avtar.png" class="img-fluid"><span>MY AVATAR</span></a>
</li>
<li>
<a href="#" data-toggle="tab"><img src="../assets/images/chat/chat.png" alt=""><span>CHAT</span></a>
</li>
<li>
<a href="#" data-toggle="tab"><img src="../assets/images/chat/watch.png" alt=""><span>CONTENT</span></a>
</li>
<li>
<a href="#" data-toggle="tab"><img src="../assets/images/chat/shops.png" alt=""><span>WORKSHOPS</span></a>
</li>   
<li>
<a href="#" data-toggle="tab"><img src="../assets/images/chat/visit.png" alt=""><span>INFO / BUY </span></a>
</li>
<li>
<a href="#6" data-toggle="tab"><img src="../assets/images/chat/program.png" alt=""><span>PROGRAM</span></a>
</li>   
