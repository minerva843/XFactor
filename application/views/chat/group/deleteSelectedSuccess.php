...
<div class="main-section"> 
    <div class="container">
        ...
        <div class="top-header">
            <div class="row">
                <div class="col-md-9">
                <h2>GROUP CHAT (DELETE<?php if($selected){ echo ""; }else{ echo " ALL"; }?>) <span class="sucess">SUCCESSFUL </span></h2> 
                    <p style="color:red">DELETE<?php if($selected){ echo ""; }else{ echo " ALL"; }?> MEANS <?php if($selected){ echo "ALL SELECTED"; }else{ echo "ALL"; }?> GROUP CHAT AND RELATED DATA CANNOT BE RETRIEVED IN FUTURE.</p> 
                </div>
        ...
        <div class="middle-body register-form zone-sucess">
            <div class="row">
				...
				<div class="leftbox-top">
					<h5> <?php if($selected){ echo "ALL SELECTED"; }else{ echo "ALL"; }?> GROUP CHAT TO BE DELETED ARE LISTED BELOW :</h5>
					</div>  
			...
			<?php } ?>
				...
				<li id="individual_chat_list" class=""><a data-toggle="tab" href="#menu1">INDIVIDUAL CHAT</a></li>
				<li id="group_chat_list" class="active"><a data-toggle="tab" href="#menu2">GROUP CHAT</a></li>
				<li class=""><a data-toggle="tab" href="#menu3">CHAT LOG</a></li>
				
                            </ul>
                            <div class="table_info floor-step">
                                
                              <p style="color:#00b050!important;"> <span class="current-bold">CURRENTLY SELECTED :</span> <span style="color:black;font-size: 14px;" ><?php if($selected && !$single){ echo "MULTIPLE GROUP CHAT"; }else if($selected && $single){echo $groups_info[0]['group_chat_name'];}else{ echo "ALL"; }?> </span></p>
								<br>
                                <p><b>TO CHECK AGAIN BEFORE <span style="color:red; font-weight: 600;"><?php echo $action; ?></span>, CLICK BACK.</b></p>
						    <p><b>ARE YOU SURE YOU WANT TO <span style="color:red; font-weight: 600;"><?php echo $action; ?> </span> GROUP CHAT?</b></p>
                            ...
                            <div class="form-submit"> 
                                ...
                                <input type="button" value="DONE" class="action-btn" name="submit" id="btngotogrouplist">
                            </div>
                        </div>
                    </div>
                </div>
...
var strids="<?php print($ids);?>";
       $.fancybox.open({
        ...
        $("body").on('click','#btngotogrouplist',function(){
        $.fancybox.getInstance('close'); 
        $.fancybox.open({
        maxWidth  : 800,
        fitToView : true,
