...
<div class="main-section"> 
    <div class="container">
        ...
        <div class="top-header">
            <div class="row">
                <div class="col-md-9">
                    <h2>GROUP CHATS (<?php echo $action; ?>) <span class="sucess">SUCCESSFUL </span></h2> 
                    <p> <b><?php echo date('Ymd hi'); ?>.</b> THIS GROUP CHAT HAS BEEN <?php echo $action; ?>ED.</p>
                </div>
        ...
        <div class="middle-body register-form zone-sucess">
            <div class="row">
				...
				<div class="leftbox-top">
					<h5> ALL GROUP CHAT DETAILS ARE LISTED BELOW :</h5>
					</div>  
					...
					<div class="col-md-9">
                        ...
                        <form>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-8">
                                    <div class="zone-label"><?=$group_info['xproj']?></div>
                                </div>
                            </div>
			...
			<h3> GROUP CHAT INFO</h3>
				...
				<li id="openindivisualchatfrmgrp333" ><a data-toggle="tab" href="#menu1">INDIVIDUAL CHAT</a></li>
				<li  class="active" id="group_chat_list33" class=""><a data-toggle="tab" href="#menu2">GROUP CHAT</a></li>
				<li class=""><a data-toggle="tab" href="#menu3">CHAT LOG</a></li>
				
                            </ul>
                            <div class="table_info floor-step">
                                
                                <p style="color:#00b050!important;"> <span class="current-bold">CURRENTLY SELECTED :</span> <span style="color:black;font-size: 14px;" ><?php if($action=='ADD'){ echo 'ADD'; }else{ echo $group_info['group_name'];}?> </span></p>
								<br>
                                <!--p><b>TO CHECK AGAIN BEFORE <span style="color:red; font-weight: 600;"><?php echo $action; ?></span>, CLICK BACK.</b></p>
						    <p><b>ARE YOU SURE YOU WANT TO <span style="color:red; font-weight: 600;"><?php echo $action; ?> </span> GROUP CHATS?</b></p-->
...
var strids="<?php print($ids);?>";
       $.fancybox.open({
        ...
        autoSize  : true,
        type        : "ajax",
        src         : "<?php echo base_url(); ?>chat/group_chat_list",
        ajax: { 
