        ...
        <div class="top-header">
            <div class="row">
                <div class="col-md-9"><?php //print_r($zone);  ?>  
                    <h2>WORKSHOP (DELETE <?php if($selected){ echo "SELECTED"; }else{ echo "ALL"; }?>) </h2>
			...
			<div class="form-group row">
				...
				<li class="active"><a data-toggle="tab" href="#menu1">MAIN MENU</a></li>
                            ...
                            <div class="form-submit"> 
                                ...
                                <input type="button" value="DELETE" class="action-btn" name="submit" id="btn555delsucessworkshop">
                            </div>
                        </div>
                    </div>
                </div>
