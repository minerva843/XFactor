...
<div class="main-section"> 
    <div class="container">
        ...
        <div class="top-header">
            <div class="row">
                <div class="col-md-9">  
                    <h2>WORKSHOP (DELETE <?php if($selected){ echo "SELECTED"; }else{ echo "ALL"; }?>) <span>SUCCESSFUL</span></h2>
                   <p style="color:red">DELETE MEANS ALL SELECTED WORKSHOPS AND RELATED DATA CANNOT BE RETRIEVED IN FUTURE.</p>
                </div>
        ...
        <div class="middle-body register-form zone-sucess">
            <div class="row">
				...
				<div class="leftbox-top">
					<h5> SELECTED WORKSHOPS TO BE DELETED ARE LISTED BELOW :</h5>
					</div>  
                    
                    <div class="zone-info delete-floorplan">
					<div class="col-md-12" id="printJS-form-iold-delete">
			...
			<div class="form-group row">
				...
				<li class="active"><a data-toggle="tab" href="#menu1">MAIN MENU</a></li>
                            ...
                            <div class="table_info floor-step">
                                ...
                                <p style="color:#00b050!important;">CURRENTLY SELECTED : <span style="color:black;font-size: 14px;" ><?php if($selected){ echo "MULTIPLE WORKSHOPS"; }else{ echo "ALL"; }?> </span></p>
								<br>
                                <p><b>TO CHECK AGAIN BEFORE <span style="color:red; font-weight: 600;">DELETE</span>, CLICK BACK.</b></p>
						    <p><b>ARE YOU SURE YOU WANT TO <span style="color:red; font-weight: 600;">DELETE </span> ZONES?</b></p>
                            ...
                            <div class="form-submit"> 
                                ...
                                <input type="button" value="DELETE" class="action-btn" name="submit" id="btn555delsucesslist">
                            </div>
                        </div>
                    </div>
                </div>
