...
<div class="main-section floor_steps" id="add-floor">  
 ...
 <form method="POST" action="">
        <div class="top-header">
            <div class="row">
                <div class="col-md-9">
                    <h2>GUEST TYPE, GUEST PREFERRED NAME, COMPANY NAME</h2>   
...
<!--  GROUP chat click -->
				...
				<div class="row group-chats">    
					...
					<h3> <a> SHOW GROUP CHAT IMAGE </a></h3>     
					<img src="assets/images/chat/delegate.png" class="img-fluid">					
					</div>
					<div class="row mt-10">
					<div class="col-md-3"> </div>
					<div class="col-md-9"> 
					<div class="form-group row">
					<label class="col-sm-4">GUEST TYPE   </label>   
					<div class="col-sm-8">
					 DELEGATE
					</div>
					</div>
					...
					<p> CLICK ON DISPLAY PHOTO TO ENLARGE AND GET CHAT GROUP MEMBER’S INFO </p>
					...
					<div class="col-sm-2">
					<img src="<?php echo base_url();?>assets/images/chat/chat-user1.png" class="img-fluid">   
					</div>
					
					<div class="col-sm-2">
					<img src="assets/images/chat/chat-user2.png" class="img-fluid">  
					</div>
					
					<div class="col-sm-2">
					<img src="assets/images/chat/chat-user3.png" class="img-fluid">  
					</div>
					
					<div class="col-sm-2">
					<img src="assets/images/chat/chat-user4.png" class="img-fluid">  
					</div>  
					
					<div class="col-sm-2">
					<img src="assets/images/chat/chat-user5.png" class="img-fluid">  
					</div>
					
					<div class="col-sm-2">
					<img src="assets/images/chat/chat-user6.png" class="img-fluid">  
					</div><div class="col-sm-2">
					<img src="assets/images/chat/chat-user1.png" class="img-fluid">   
					</div>
                ...
                <div class="col-md-3 right-text">
                    <div class="tab right-tabs chat-rights">
						...
						<ul class="nav nav-tabs" role="tablist">  
							...
							<p>DELEGATE, PROF CORONA RESEARCH, THE
RESEARCH COMPANY    
</p>       
							</div>
							</div> 
							...
							<div class="chat-inscroll">
								...
								<div class="mp-system-right"> <div><a href="#"> download</a> <a href="#"> Display</a> </div> </div>
								</div>     
