...
<?php } ?>   
				...
				<li class="active"><a data-toggle="tab" href="#menu1">MAIN MENU</a></li>
                            ...
                            <div class="table_info floor-step">
                                <p style="color:#00b050!important;">CURRENTLY SELECTED : <span style="color:black;font-size: 14px !important;font-weight: normal;">ALL PROJECTS</span></p>
                               
                                <div class="tab-content sucess-tab-page">
  
                                    <p><b>TO CHECK AGAIN BEFORE <span style="color:red; font-size: 14px !important; font-weight:bold !important;">DELETE ALL</span>, CLICK BACK.</b></p> <br>
