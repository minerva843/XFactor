...
<form action="<?php echo base_url(); ?>UserManage/processAddGroup/<?php echo $group->id; ?>" method="POST" id="adduserGroupErr<?=$randid?>">
                    ...
                    <div class="tab right-tabs">
                        ...
                        <div class="table-content add-zone-1">	  
                            <ul class="nav nav-tabs ">
				                ...
				                <li id="alluserpermission45454"><a data-toggle="tab" href="#menu2">PERMISSIONS</a></li>
				                <li class="" id="assignuser4748" ><a data-toggle="tab" href="#menu3">ASSIGNED USERS</a></li>
    ...
    <div class="modal-content">
        <div class="modal-body">
            <h4> GROUP (ADD) <span style="color:red ;font-weight:bold;">NOT SUCCESSFUL </span></h4>
				<p style="color:red">UNABLE TO CREATE GROUP 1.</p>
				<p   style="color:red">PLEASE TRY ANOTHER GROUP NAME.</p>
				<p   style="color:red" >GROUP NAME THAT WAS ENTERED IS RESERVED.</p>
        </div>
...
$.fancybox.getInstance('close');
     ...
     $.validator.setDefaults({
	    submitHandler: function() {             
            var form = $("#adduserGroupErr<?=$randid?>");
	...
	clickSlide: false,
        ...
        $("#adduserGroupErr<?=$randid?>").validate({
			rules: {
				group_name: "required",
				group_type: "required",
