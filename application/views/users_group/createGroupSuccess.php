        ...
        <div class="top-header">
            <div class="row">
                <div class="col-md-9">
                    ...
                    <p> <b><?php echo date('Ymd Gi'); ?>h.</b> THIS GROUP HAS BEEN <?php echo $action; ?>ED.</p>
                </div>
...
<div class="row">
                                    ...
                                    <div class="col-md-9">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-8">
                                                <div class="zone-label running_latter"><?=$user['phone']?></div>    
                                            </div>
                                        </div>
				...
				<li class="" id="assignuserlist33090" ><a data-toggle="tab" href="#menu3">ASSIGNED USERS</a></li>
                            ...
                            <div class="table_info floor-step">
                                ...
                                <p><span class="current-bold">CURRENTLY SELECTED :</span> <span style="color:black;font-size: 14px;" ><?php if($action=="ADD"){ echo "GROUP (ADD)"; }else{ echo $group_info['group_name']; }?> </span></p>
								<br>
                                <!--p><b>TO CHECK AGAIN BEFORE <span style="color:red; font-weight: 600!important"><?php echo $action; ?></span>, CLICK BACK.</b></p>
						    <p><b>ARE YOU SURE YOU WANT TO <span style="color:red; font-weight: 600!important"><?php echo $action; ?> </span> GROUPS ?</b></p-->
