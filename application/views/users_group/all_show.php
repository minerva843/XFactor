...
<div class="main-section">
    <div class="container">
        ...
        <div class="top-header">
            <div class="row">
                <div class="col-md-9">
                    <h2>GROUPS <span id="actiontopText" style="font-size:18px;"></span></h2>
                </div>
                        ...
                        <div class="floor-sec">
                            <div class="tab-listing">
                                <div class="row master-filters">
                                    ...
                                    <div class="col-md-1"><button class="src-btn1" id="addNewUserGroup">ADD</button></div>
                                    ...
                                    <div class="col-md-1"><button class="src-btn1" id="deleteAllGroups">DELETE ALL</button></div>
                                </div>
                                    ...
                                    $(document).ready(function() {
                                        ...
                                        $("#delete_zone").click(function() {
                                            ...
                                            if ($(this).hasClass('activebtn')) {
                                                ...
                                                $("#ViewSingleData").find('#currentlyViewing').css("display", "contents");
                                                $("#ViewSingleData").empty().html('<p><span class="work-shop_gap current-bold">CURRENTLY SELECTED:</span> NO GROUPS SELECTED.</p><p><span>CURRENTLY VIEWING:</span> NO GROUPS SELECTED.</p>');
       ...
       $.fancybox.open({
        ...
        autoSize  : true,
        type        : "ajax",
        src         : "<?=base_url();?>UserManage/deleteSelectedGroupUsers",
        ajax: { 
                                            ...
                                            if ($("#editAction").hasClass('activebtn')) {
                                                ...
                                                if (grp_id) {
                                                    ...
                                                    $.fancybox.open({
                                                        ...
                                                        autoSize: true,
                                                        type: "ajax",
                                                        src: '<?= base_url(); ?>UserManage/addNewUserGroup/' + grp_id,
                                                        ajax: {
                                                            settings: {
                                                                data: '',
                                                                type: 'POST'
                    ...
                    <div class="tab right-tabs">
                        ...
                        <div class="table-content">
                            <ul class="nav nav-tabs ">
                                ...
                                <li id="openuserpermissions" class=""><a data-toggle="tab"  href="#home">PERMISSIONS</a></li>
                                <li class="" id="assignusergroup"><a data-toggle="tab" href="#">ASSIGN USERS</a></li>
...
<div id="myModal1usergroup" class="modal delete-sorting">
    ...
    <div class="modal-content">
        <div class="modal-body">
            <h4>GROUP (EDIT) <span style="color:red ;font-weight:bold;">NOT SUCCESSFUL </span></h4>
...
<div id="myModal2usergroup" class="modal delete-sorting">
    ...
    <div class="modal-content">
        <div class="modal-body">
            <h4> GROUP (DELETE) <span style="color:red ;font-weight:bold;">NOT SUCCESSFUL </span></h4>
            <p>NO ENTRY SELECTED.</p>
