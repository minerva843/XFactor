...
class Ion_auth
{
	...
	public function register($identity, $password, $email, $additional_data = [], $group_ids = [],$project_id=false,$guest=false)
	{
		...
		$url = "http://54.179.99.134/api/v4/users";
			...
			$post_dataa = array (
				...
				"user_id" => $additional_data['username']
			);
			$curll = curl_init();
	...
	public function deactivate($id = NULL)
	{
        ...
        function retriveUserId($first_name,$last_name,$country_code,$mobile,$gender,$birthday,$company){
           // print_r($first_name); exit;
             return $this->ion_auth_model->retriveUserId($first_name,$last_name,$country_code,$mobile,$gender,$birthday,$company);
