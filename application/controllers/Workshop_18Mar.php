...
//		$data['allgroups'] = json_decode($response);    //commented on 14-Feb
	...
	public function fullscreen()
	{
       ...
       if($id){
          ...
          'last_edited_username'=>'XP'.$this->session->userdata('username')
        ); 
			...
			if($data > 0)
			{
				...
				if(!empty($data->last_edited_username)){ 
					...
					$output .= '    
                                        ...
                                        <tr>
						<td colspan="2" class="top-fp"><p><span>CURRENTLY SELECTED : </span> <span id="multipleprojectselect" style="color:black;" > '.$data->workshop_name.'</span></p></td>
					</tr>
                                        
                                        <tr id="currentlyViewing" >
						<td  colspan="2" class="currentlyviewingclass"><p><span>CURRENTLY VIEWING : </span> <span class="pname"> '.$data->workshop_name.'</span></p></td>
					</tr>
					...
					<tr>
						<td colspan="2" class="res_clas sp_abc what-hots-details-right">'.$data->instructions.'</td>
				...
				$output .= '
						<p><span>Currently Selected : </span>NO WORKSHOP SELECTED</p>
