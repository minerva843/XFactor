	   ...
	   a("#saveAvatar").on("click", function () {
            ...
            a.ajax({ url: c.pathToFolder + "php/save-temp-avatar.php", type: "post", dataType: "text", data: { imgdata: b, filename: h,user:user }, cache: !1 })
                .done(function (b) {
                    ...
                    a("#avatar_small_dyanmic").attr('src','../assets/svgavatar/for_upload/svgavatars/temp-avatars/'+b);
                    a("#avatar_small_dyanmic_dn").attr('href','../assets/svgavatar/for_upload/svgavatars/temp-avatars/'+b);
            //alert(b);
                 //   "saved" === b
